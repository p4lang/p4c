...
TEST(expr_uses, expr_uses) {
    ...
    IR::Ptr<IR::Expression> add = new IR::Add(obj1_f1, obj2_f11);
    IR::Ptr<IR::Expression> sub = new IR::Sub(obj1_f11, obj2_f1);
    IR::Ptr<IR::Expression> add2 = new IR::Add(obj1_f1, obj1_f11);
