...
ParserOptions::ParserOptions() : Util::Options(defaultMessage) {
    ...
    registerOption("--parser-inline-opt", nullptr,
                   [this](const char*) {
    ...
    registerOption("--doNotEmitIncludes", "condition",
                   [this](const char* arg) {
                       noIncludes = arg;
                       return true;
                   },
