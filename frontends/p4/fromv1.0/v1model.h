...
struct Cloner_Model : public ::Model::Extern_Model {
    Cloner_Model() : Extern_Model("clone"), clone3("clone3_field_list"), cloneType(),
...
class V1Model : public ::Model::Model {
 protected:
    V1Model() :
            ...
            action_selector(), clone(), resubmit("resubmit_field_list"),
            ...
            recirculate("recirculate_field_list"), verify_checksum("verify_checksum"),
