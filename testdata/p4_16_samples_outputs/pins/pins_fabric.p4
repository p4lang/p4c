...
control routing(in headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
    ...
    @max_group_size(256) action_selector(HashAlgorithm.identity, 65536, 16) wcmp_group_selector;
...
control mirroring_encap(inout headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
    apply {
        if (standard_metadata.instance_type == 1) {
            ...
            headers.erspan_ethernet.ether_type = 0x800;
            ...
            headers.erspan_ipv4.total_len = 20 + 4 + (bit<16>)standard_metadata.packet_length;
...
control acl_egress(in headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
  ...
  ") table acl_egress_table {
        key = {
            ...
            ip_protocol                                     : ternary @name("ip_protocol") @id(2) @sai_field(SAI_ACL_TABLE_ATTR_FIELD_IP_PROTOCOL);
            ...
            dscp                                            : ternary @name("dscp") @id(8) @sai_field(SAI_ACL_TABLE_ATTR_FIELD_DSCP);
        }
        actions = {
...
control admit_google_system_mac(in headers_t headers, inout local_metadata_t local_metadata) {
    apply {
        local_metadata.admit_to_l3 = headers.ethernet.dst_addr & 0x10000000000 == 0;
    }
}
...
@pkginfo(name="fabric_border_router.p4", organization="Google") V1Switch(packet_parser(), verify_ipv4_checksum(), ingress(), egress(), compute_ipv4_checksum(), packet_deparser()) main;
