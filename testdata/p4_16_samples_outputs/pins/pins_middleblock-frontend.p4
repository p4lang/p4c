...
control ingress(inout headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
    ...
    @id(0x01000005) @name(".set_nexthop_id") action set_nexthop_id_2(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") nexthop_id_t nexthop_id_3) {
        local_metadata_1 = local_metadata;
        local_metadata_1.nexthop_id_valid = true;
        local_metadata_1.nexthop_id_value = nexthop_id_3;
        local_metadata = local_metadata_1;
    }
    @id(0x01000005) @name(".set_nexthop_id") action set_nexthop_id_3(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") nexthop_id_t nexthop_id_4) {
        local_metadata_8 = local_metadata;
        local_metadata_8.nexthop_id_valid = true;
        local_metadata_8.nexthop_id_value = nexthop_id_4;
  ...
  ") @p4runtime_role("sdn_controller") @id(0x0200004A) @name("ingress.routing_lookup.vrf_table") table routing_lookup_vrf_table {
    ...
    @id(0x01000010) @name("ingress.routing_lookup.set_nexthop_id_and_metadata") action routing_lookup_set_nexthop_id_and_metadata_0(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") nexthop_id_t nexthop_id_5, @name("route_metadata") route_metadata_t route_metadata_7) {
    ...
    @id(0x01000010) @name("ingress.routing_lookup.set_nexthop_id_and_metadata") action routing_lookup_set_nexthop_id_and_metadata_1(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") nexthop_id_t nexthop_id_6, @name("route_metadata") route_metadata_t route_metadata_8) {
        local_metadata.nexthop_id_valid = true;
        local_metadata.nexthop_id_value = nexthop_id_6;
  ...
  ") @name("ingress.routing_lookup.set_multicast_group_id") action routing_lookup_set_multicast_group_id_0(@id(1) @refers_to(builtin : : multicast_group_table , multicast_group_id) @name("multicast_group_id") multicast_group_id_t multicast_group_id) {
    ...
    // Disallow 0 since it encodes 'no multicast' in V1Model.
    multicast_group_id != 0;
  ") @name("ingress.routing_lookup.set_multicast_group_id") action routing_lookup_set_multicast_group_id_1(@id(1) @refers_to(builtin : : multicast_group_table , multicast_group_id) @name("multicast_group_id") multicast_group_id_t multicast_group_id_2) {
    ...
    @id(0x01000102) @sai_action(SAI_PACKET_ACTION_TRAP , SAI_PACKET_COLOR_GREEN) @sai_action(SAI_PACKET_ACTION_DROP , SAI_PACKET_COLOR_RED) @name("ingress.acl_ingress.acl_trap") action acl_ingress_acl_trap_0(@sai_action_param(QOS_QUEUE) @id(1) @name("qos_queue") qos_queue_t qos_queue_2) {
    ...
    @id(0x01000104) @sai_action(SAI_PACKET_ACTION_FORWARD) @name("ingress.acl_ingress.acl_mirror") action acl_ingress_acl_mirror_1(@id(1) @refers_to(mirror_session_table , mirror_session_id) @sai_action_param(SAI_ACL_ENTRY_ATTR_ACTION_MIRROR_INGRESS) @name("mirror_session_id") mirror_session_id_t mirror_session_id_2) {
        acl_ingress_acl_ingress_counter.count();
        local_metadata.marked_to_mirror = true;
        local_metadata.mirror_session_id = mirror_session_id_2;
    }
  ...
  ") @name("ingress.acl_ingress.acl_ingress_table") table acl_ingress_acl_ingress_table {
    ...
    @id(0x01000112) @name("ingress.acl_ingress.redirect_to_nexthop") action acl_ingress_redirect_to_nexthop_0(@sai_action_param(SAI_ACL_ENTRY_ATTR_ACTION_REDIRECT) @sai_action_param_object_type(SAI_OBJECT_TYPE_NEXT_HOP) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") nexthop_id_t nexthop_id_7) {
        local_metadata.nexthop_id_valid = true;
        local_metadata.nexthop_id_value = nexthop_id_7;
        local_metadata.wcmp_group_id_valid = false;
