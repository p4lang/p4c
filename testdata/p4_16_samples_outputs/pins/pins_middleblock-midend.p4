...
control ingress(inout headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
    ...
    @id(0x01000005) @name(".set_nexthop_id") action set_nexthop_id_2(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") bit<10> nexthop_id_3) {
        local_metadata._nexthop_id_valid39 = true;
        local_metadata._nexthop_id_value40 = nexthop_id_3;
    }
    @id(0x01000005) @name(".set_nexthop_id") action set_nexthop_id_3(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") bit<10> nexthop_id_4) {
        local_metadata._nexthop_id_valid39 = true;
  ...
  ") @p4runtime_role("sdn_controller") @id(0x0200004A) @name("ingress.routing_lookup.vrf_table") table routing_lookup_vrf_table {
    ...
    @id(0x01000011) @name("ingress.routing_lookup.set_wcmp_group_id_and_metadata") action routing_lookup_set_wcmp_group_id_and_metadata_0(@id(1) @refers_to(wcmp_group_table , wcmp_group_id) @name("wcmp_group_id") bit<12> wcmp_group_id_3, @name("route_metadata") bit<6> route_metadata_3) {
        @id(0x01000004) @inlinedAt("routing_lookup_set_wcmp_group_id") {
            local_metadata._wcmp_group_id_valid37 = true;
    ...
    @id(0x01000010) @name("ingress.routing_lookup.set_nexthop_id_and_metadata") action routing_lookup_set_nexthop_id_and_metadata_0(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") bit<10> nexthop_id_5, @name("route_metadata") bit<6> route_metadata_7) {
        local_metadata._nexthop_id_valid39 = true;
        local_metadata._nexthop_id_value40 = nexthop_id_5;
        local_metadata._route_metadata34 = route_metadata_7;
    }
    @id(0x01000010) @name("ingress.routing_lookup.set_nexthop_id_and_metadata") action routing_lookup_set_nexthop_id_and_metadata_1(@id(1) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") bit<10> nexthop_id_6, @name("route_metadata") bit<6> route_metadata_8) {
        local_metadata._nexthop_id_valid39 = true;
        local_metadata._nexthop_id_value40 = nexthop_id_6;
  ...
  ") @name("ingress.routing_lookup.set_multicast_group_id") action routing_lookup_set_multicast_group_id_0(@id(1) @refers_to(builtin : : multicast_group_table , multicast_group_id) @name("multicast_group_id") bit<16> multicast_group_id) {
    ...
    // Disallow 0 since it encodes 'no multicast' in V1Model.
    multicast_group_id != 0;
  ") @name("ingress.routing_lookup.set_multicast_group_id") action routing_lookup_set_multicast_group_id_1(@id(1) @refers_to(builtin : : multicast_group_table , multicast_group_id) @name("multicast_group_id") bit<16> multicast_group_id_2) {
        standard_metadata.mcast_grp = multicast_group_id_2;
    }
    ...
    @id(0x01000102) @sai_action(SAI_PACKET_ACTION_TRAP , SAI_PACKET_COLOR_GREEN) @sai_action(SAI_PACKET_ACTION_DROP , SAI_PACKET_COLOR_RED) @name("ingress.acl_ingress.acl_trap") action acl_ingress_acl_trap_0(@sai_action_param(QOS_QUEUE) @id(1) @name("qos_queue") bit<8> qos_queue_2) {
        @id(0x01000101) @sai_action(SAI_PACKET_ACTION_COPY , SAI_PACKET_COLOR_GREEN) @sai_action(SAI_PACKET_ACTION_FORWARD , SAI_PACKET_COLOR_RED) @inlinedAt("acl_ingress_acl_copy") {
            acl_ingress_acl_ingress_counter.count();
            acl_ingress_acl_ingress_meter.read(local_metadata._color32);
            local_metadata._marked_to_copy18 = true;
        }
    ...
    @id(0x01000103) @sai_action(SAI_PACKET_ACTION_FORWARD , SAI_PACKET_COLOR_GREEN) @sai_action(SAI_PACKET_ACTION_DROP , SAI_PACKET_COLOR_RED) @name("ingress.acl_ingress.acl_forward") action acl_ingress_acl_forward_2() {
        acl_ingress_acl_ingress_meter.read(local_metadata._color32);
    }
    ...
    @id(0x01000104) @sai_action(SAI_PACKET_ACTION_FORWARD) @name("ingress.acl_ingress.acl_mirror") action acl_ingress_acl_mirror_1(@id(1) @refers_to(mirror_session_table , mirror_session_id) @sai_action_param(SAI_ACL_ENTRY_ATTR_ACTION_MIRROR_INGRESS) @name("mirror_session_id") bit<10> mirror_session_id_2) {
        acl_ingress_acl_ingress_counter.count();
        local_metadata._marked_to_mirror19 = true;
        local_metadata._mirror_session_id20 = mirror_session_id_2;
    }
    @id(0x0100010F) @sai_action(SAI_PACKET_ACTION_DENY) @name("ingress.acl_ingress.acl_deny") action acl_ingress_acl_deny_0() {
        acl_ingress_cancel_copy = true;
        local_metadata._acl_drop42 = true;
    }
  ...
  ") @name("ingress.acl_ingress.acl_ingress_table") table acl_ingress_acl_ingress_table {
    ...
    @id(0x01000112) @name("ingress.acl_ingress.redirect_to_nexthop") action acl_ingress_redirect_to_nexthop_0(@sai_action_param(SAI_ACL_ENTRY_ATTR_ACTION_REDIRECT) @sai_action_param_object_type(SAI_OBJECT_TYPE_NEXT_HOP) @refers_to(nexthop_table , nexthop_id) @name("nexthop_id") bit<10> nexthop_id_7) {
        local_metadata._nexthop_id_valid39 = true;
        local_metadata._nexthop_id_value40 = nexthop_id_7;
        local_metadata._wcmp_group_id_valid37 = false;
  ...
  ") @name("ingress.acl_ingress.redirect_to_ipmc_group") action acl_ingress_redirect_to_ipmc_group_0(@sai_action_param(SAI_ACL_ENTRY_ATTR_ACTION_REDIRECT) @sai_action_param_object_type(SAI_OBJECT_TYPE_IPMC_GROUP) @refers_to(builtin : : multicast_group_table , multicast_group_id) @name("multicast_group_id") bit<16> multicast_group_id_3) {
    ...
    is_ipv4::mask != 0 -> (is_ipv4 == 1);
    is_ipv6::mask != 0 -> (is_ipv6 == 1);
  ") @name("ingress.acl_ingress.acl_ingress_mirror_and_redirect_table") table acl_ingress_acl_ingress_mirror_and_redirect_table {
        key = {
            key_6                           : optional @id(2) @name("is_ip") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ACL_IP_TYPE / IP);
            ...
            local_metadata._vrf_id3         : optional @id(8) @name("vrf_id") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_VRF_ID);
            local_metadata._ipmc_table_hit41: optional @id(9) @name("ipmc_table_hit") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_IPMC_NPU_META_DST_HIT);
        }
        actions = {
            @proto_id(4) acl_ingress_acl_forward_1();
            @proto_id(1) acl_ingress_acl_mirror_1();
            @proto_id(2) acl_ingress_redirect_to_nexthop_0();
            @proto_id(3) acl_ingress_redirect_to_ipmc_group_0();
  ...
  // spit out nonsense.
    ...
    is_ipv4::mask != 0 -> (is_ipv4 == 1);
    is_ipv6::mask != 0 -> (is_ipv6 == 1);
  ") @name("ingress.acl_ingress.acl_ingress_security_table") table acl_ingress_acl_ingress_security_table {
        key = {
            key_8                        : optional @id(1) @name("is_ip") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ACL_IP_TYPE / IP);
            headers.ipv4.isValid()       : optional @id(2) @name("is_ipv4") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ACL_IP_TYPE / IPV4ANY);
            headers.ipv6.isValid()       : optional @id(3) @name("is_ipv6") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ACL_IP_TYPE / IPV6ANY);
            headers.ethernet.ether_type  : ternary @id(4) @name("ether_type") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ETHER_TYPE);
        ...
        actions = {
            @proto_id(1) acl_ingress_acl_forward_2();
            @proto_id(2) acl_drop_3();
            @proto_id(3) acl_ingress_acl_deny_0();
            @defaultonly NoAction_10();
        }
        const default_action = NoAction_10();
        counters = acl_ingress_acl_ingress_security_counter;
        size = 255;
    }
    ...
    @id(0x01000002) @name("ingress.routing_resolution.set_port_and_src_mac") action routing_resolution_set_port_and_src_mac_0(@id(1) @name("port") bit<9> port_3, @id(2) @format(MAC_ADDRESS) @name("src_mac") bit<48> src_mac_5) {
        @id(0x0100001B) @unsupported @action_restriction("
    // Disallow reserved VLAN IDs with implementation-defined semantics.
    vlan_id != 0 && vlan_id != 4095") @inlinedAt("routing_resolution_set_port_and_src_mac_and_vlan_id") {
    ...
    @id(0x01000014) @name("ingress.routing_resolution.set_ip_nexthop") action routing_resolution_set_ip_nexthop_0(@id(1) @refers_to(router_interface_table , router_interface_id) @refers_to(neighbor_table , router_interface_id) @name("router_interface_id") bit<10> router_interface_id_4, @id(2) @format(IPV6_ADDRESS) @refers_to(neighbor_table , neighbor_id) @name("neighbor_id") bit<128> neighbor_id_3) {
        @id(0x01000017) @inlinedAt("routing_resolution_set_ip_nexthop_and_disable_rewrites") {
            routing_resolution_router_interface_id_valid = true;
    ...
    @id(0x01000003) @deprecated("Use set_ip_nexthop instead.") @name("ingress.routing_resolution.set_nexthop") action routing_resolution_set_nexthop_0(@id(1) @refers_to(router_interface_table , router_interface_id) @refers_to(neighbor_table , router_interface_id) @name("router_interface_id") bit<10> router_interface_id_5, @id(2) @format(IPV6_ADDRESS) @refers_to(neighbor_table , neighbor_id) @name("neighbor_id") bit<128> neighbor_id_4) {
        @id(0x01000014) @inlinedAt("routing_resolution_set_ip_nexthop") {
            @id(0x01000017) @inlinedAt("routing_resolution_set_ip_nexthop_and_disable_rewrites") {
                routing_resolution_router_interface_id_valid = true;
...
control egress(inout headers_t headers, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
  ...
  ") @name("egress.acl_egress.acl_egress_table") table acl_egress_acl_egress_table {
        key = {
            ...
            key_10                       : optional @id(5) @name("is_ip") @sai_field(SAI_ACL_TABLE_ATTR_FIELD_ACL_IP_TYPE / IP);
