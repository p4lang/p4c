...
control MainControlImpl(inout headers hdr, inout main_metadata_t user_meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    Counter<bit<10>, bit<12>>(32w1024, PNA_CounterType_t.PACKETS_AND_BYTES) counter0;
    Counter<bit<10>, bit<12>>(32w1024, PNA_CounterType_t.PACKETS) counter1;
    Counter<bit<10>, bit<12>>(32w1024, PNA_CounterType_t.BYTES) counter2;
    Register<bit<32>, bit<12>>(32w1024) reg;
    Meter<bit<12>>(32w1024, PNA_MeterType_t.BYTES) meter0;
