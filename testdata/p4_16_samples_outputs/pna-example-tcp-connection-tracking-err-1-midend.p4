...
control MainControlImpl(inout headers_t hdr, inout metadata_t meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @name("MainControlImpl.tcp_fin_or_rst_packet") action tcp_fin_or_rst_packet() {
        new_expire_time_profile_id_0 = 8w0;
    }
    @name("MainControlImpl.tcp_other_packets") action tcp_other_packets() {
        new_expire_time_profile_id_0 = 8w2;
    }
    ...
    @hidden action pnaexampletcpconnectiontrackingerr1l254() {
    ...
    @hidden table tbl_pnaexampletcpconnectiontrackingerr1l254 {
        actions = {
            pnaexampletcpconnectiontrackingerr1l254();
        }
        const default_action = pnaexampletcpconnectiontrackingerr1l254();
    }
    apply {
        ...
        if (hdr.ipv4.isValid() && hdr.tcp.isValid()) {
            tbl_pnaexampletcpconnectiontrackingerr1l254.apply();
...
control MainDeparserImpl(packet_out pkt, in headers_t hdr, in metadata_t meta, in pna_main_output_metadata_t ostd) {
    @hidden action pnaexampletcpconnectiontrackingerr1l328() {
        pkt.emit<ethernet_t>(hdr.eth);
    }
    @hidden table tbl_pnaexampletcpconnectiontrackingerr1l328 {
        actions = {
            pnaexampletcpconnectiontrackingerr1l328();
        }
        const default_action = pnaexampletcpconnectiontrackingerr1l328();
    }
    apply {
        tbl_pnaexampletcpconnectiontrackingerr1l328.apply();
    }
}
