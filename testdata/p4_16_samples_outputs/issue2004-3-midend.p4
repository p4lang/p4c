...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    state start {
        ...
        transition select(hdr.ethernet.etherType) {
            16w1 &&& 16w65535: accept;
            16w2 &&& 16w65534: accept;
            16w4 &&& 16w65534: accept;
            16w15 &&& 16w65535: accept;
            16w16 &&& 16w65532: accept;
            16w20 &&& 16w65535: accept;
            16w6 &&& 16w65534: accept;
            16w8 &&& 16w65532: accept;
            16w12 &&& 16w65534: accept;
            16w14 &&& 16w65535: accept;
            default: reject;
        }
    }
}
