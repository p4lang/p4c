...
control MyIC(inout headers_t hdr, inout user_meta_t b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("MyIC.a1") action a1() {
        b.data0 = h0_0.get_hash<tuple_0>((tuple_0){f0 = hdr.ethernet.srcAddr,f1 = hdr.ethernet.etherType,f2 = hdr.ipv4.protocol});
        b.data1 = h1_0.get_hash<tuple_0>((tuple_0){f0 = hdr.ethernet.srcAddr,f1 = hdr.ethernet.etherType,f2 = hdr.ipv4.protocol});
    }
