...
control dash_ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_tunnel_mapping") action set_tunnel_mapping_0(@SaiVal[type="sai_ip_address_t"] @name("underlay_dip") IPv4Address underlay_dip_7, @name("overlay_dmac") EthernetAddress overlay_dmac, @name("use_dst_vnet_vni") bit<1> use_dst_vnet_vni, @name("meter_class") bit<16> meter_class_13, @name("meter_class_override") bit<1> meter_class_override) {
        ...
        if (underlay_dmac_1 == 48w0) {
            tmp_9 = meta_10.encap_data.underlay_dmac;
        } else {
            tmp_9 = underlay_dmac_1;
        }
        meta_10.encap_data.underlay_dmac = tmp_9;
        if (underlay_sip_1 == 32w0) {
            tmp_10 = meta_10.encap_data.underlay_sip;
        } else {
            tmp_10 = underlay_sip_1;
        }
        meta_10.encap_data.underlay_sip = tmp_10;
        if (underlay_dip_1 == 32w0) {
            tmp_39 = meta_10.encap_data.underlay_dip;
        } else {
            tmp_39 = underlay_dip_1;
        }
        meta_10.encap_data.underlay_dip = tmp_39;
        if (overlay_dmac_1 == 48w0) {
            tmp_40 = meta_10.overlay_data.dmac;
        } else {
            tmp_40 = overlay_dmac_1;
        }
        meta_10.overlay_data.dmac = tmp_40;
        meta_42 = meta_10;
        meta_11 = meta_42;
    ...
    @name(".set_private_link_mapping") action set_private_link_mapping_0(@SaiVal[type="sai_ip_address_t"] @name("underlay_dip") IPv4Address underlay_dip_8, @name("overlay_sip") IPv6Address overlay_sip_2, @name("overlay_dip") IPv6Address overlay_dip_2, @SaiVal[type="sai_dash_encapsulation_t"] @name("dash_encapsulation") dash_encapsulation_t dash_encapsulation_3, @name("tunnel_key") bit<24> tunnel_key_4, @name("meter_class") bit<16> meter_class_14, @name("meter_class_override") bit<1> meter_class_override_3) {
        ...
        tmp_41 = meta_43.eni_data.pl_underlay_sip;
        meta_30 = meta_43;
        encap_2 = dash_encapsulation_3;
        vni_4 = tunnel_key_4;
        underlay_sip_3 = tmp_41;
        ...
        if (vni_4 == 24w0) {
            tmp_43 = meta_30.encap_data.vni;
        } else {
            tmp_43 = vni_4;
        }
        meta_30.encap_data.vni = tmp_43;
        if (underlay_smac_11 == 48w0) {
            tmp_44 = meta_30.encap_data.underlay_smac;
        } else {
            tmp_44 = underlay_smac_11;
        }
        meta_30.encap_data.underlay_smac = tmp_44;
        if (underlay_dmac_11 == 48w0) {
            tmp_45 = meta_30.encap_data.underlay_dmac;
        } else {
            tmp_45 = underlay_dmac_11;
        }
        meta_30.encap_data.underlay_dmac = tmp_45;
        if (underlay_sip_3 == 32w0) {
            tmp_46 = meta_30.encap_data.underlay_sip;
        } else {
            tmp_46 = underlay_sip_3;
        }
        meta_30.encap_data.underlay_sip = tmp_46;
        if (underlay_dip_3 == 32w0) {
            tmp_47 = meta_30.encap_data.underlay_dip;
        } else {
            tmp_47 = underlay_dip_3;
        }
        meta_30.encap_data.underlay_dip = tmp_47;
        if (overlay_dmac_3 == 48w0) {
            tmp_48 = meta_30.overlay_data.dmac;
        } else {
            tmp_48 = overlay_dmac_3;
        }
        meta_30.overlay_data.dmac = tmp_48;
        meta_43 = meta_30;
        tmp_42 = overlay_sip_2 & ~meta_43.eni_data.pl_sip_mask | meta_43.eni_data.pl_sip | (IPv6Address)hdr_10.u0_ipv4.src_addr;
        meta_31 = meta_43;
        sip_2 = tmp_42;
    ...
    @name(".push_vxlan_tunnel_u0") action push_vxlan_tunnel_u0_1() {
        ...
        if (overlay_dmac_12 == 48w0) {
            tmp_49 = hdr_24.customer_ethernet.dst_addr;
        } else {
            tmp_49 = overlay_dmac_12;
        }
    ...
    @name(".push_vxlan_tunnel_u0") action push_vxlan_tunnel_u0_2() {
        ...
        if (overlay_dmac_13 == 48w0) {
            tmp_50 = hdr_25.customer_ethernet.dst_addr;
        } else {
            tmp_50 = overlay_dmac_13;
        }
    ...
    @name(".push_vxlan_tunnel_u0") action push_vxlan_tunnel_u0_3() {
        ...
        if (overlay_dmac_14 == 48w0) {
            tmp_51 = hdr_26.customer_ethernet.dst_addr;
        } else {
            tmp_51 = overlay_dmac_14;
        }
    ...
    @name(".push_vxlan_tunnel_u1") action push_vxlan_tunnel_u1_1() {
        ...
        if (overlay_dmac_15 == 48w0) {
            tmp_52 = hdr_27.u0_ethernet.dst_addr;
        } else {
            tmp_52 = overlay_dmac_15;
        }
    ...
    @name(".push_vxlan_tunnel_u1") action push_vxlan_tunnel_u1_2() {
        ...
        if (overlay_dmac_16 == 48w0) {
            tmp_53 = hdr_28.u0_ethernet.dst_addr;
        } else {
            tmp_53 = overlay_dmac_16;
        }
    ...
    @name(".push_vxlan_tunnel_u1") action push_vxlan_tunnel_u1_3() {
        ...
        if (overlay_dmac_17 == 48w0) {
            tmp_54 = hdr_29.u0_ethernet.dst_addr;
        } else {
            tmp_54 = overlay_dmac_17;
        }
