...
control dash_ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".vxlan_encap") action vxlan_encap_1() {
        ...
        hdr_15.ipv4.total_len = hdr_15.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_15.inner_ipv4.isValid() + hdr_15.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w50;
        ...
        hdr_15.udp.length = hdr_15.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_15.inner_ipv4.isValid() + hdr_15.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w30;
    ...
    @name(".vxlan_encap") action vxlan_encap_2() {
        ...
        hdr_16.ipv4.total_len = hdr_16.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_16.inner_ipv4.isValid() + hdr_16.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_16.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_16.inner_ipv6.isValid() + 16w50;
        ...
        hdr_16.udp.length = hdr_16.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_16.inner_ipv4.isValid() + hdr_16.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_16.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_16.inner_ipv6.isValid() + 16w30;
    ...
    @name(".vxlan_encap") action vxlan_encap_3() {
        ...
        hdr_17.ipv4.total_len = hdr_17.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_17.inner_ipv4.isValid() + hdr_17.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_17.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_17.inner_ipv6.isValid() + 16w50;
        ...
        hdr_17.udp.length = hdr_17.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_17.inner_ipv4.isValid() + hdr_17.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_17.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_17.inner_ipv6.isValid() + 16w30;
    ...
    @name(".nvgre_encap") action nvgre_encap_1() {
        ...
        hdr_18.ipv4.total_len = hdr_18.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_18.inner_ipv4.isValid() + hdr_18.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_18.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_18.inner_ipv6.isValid() + 16w42;
    ...
    @name(".nvgre_encap") action nvgre_encap_2() {
        ...
        hdr_19.ipv4.total_len = hdr_19.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_19.inner_ipv4.isValid() + hdr_19.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_19.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_19.inner_ipv6.isValid() + 16w42;
    ...
    apply {
        ...
        if (meta.direction == dash_direction_t.OUTBOUND) {
            meter_bucket_outbound_0.count(meta.meter_bucket_index);
        } else if (meta.direction == dash_direction_t.INBOUND) {
            meter_bucket_inbound_0.count(meta.meter_bucket_index);
        }
        eni_meter_0.apply();
        if (meta.dropped) {
            drop_action();
