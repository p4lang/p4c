...
control dash_ingress(inout headers_t hdr, inout metadata_t meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".vxlan_encap") action vxlan_encap_1() {
        ...
        hdr_12.ipv4.total_len = hdr_12.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_12.inner_ipv4.isValid() + hdr_12.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_12.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_12.inner_ipv6.isValid() + 16w50;
        ...
        hdr_12.udp.length = hdr_12.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_12.inner_ipv4.isValid() + hdr_12.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_12.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_12.inner_ipv6.isValid() + 16w30;
    ...
    @name(".vxlan_encap") action vxlan_encap_2() {
        ...
        hdr_13.ipv4.total_len = hdr_13.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_13.inner_ipv4.isValid() + hdr_13.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_13.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_13.inner_ipv6.isValid() + 16w50;
        ...
        hdr_13.udp.length = hdr_13.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_13.inner_ipv4.isValid() + hdr_13.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_13.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_13.inner_ipv6.isValid() + 16w30;
    ...
    @name(".vxlan_encap") action vxlan_encap_3() {
        ...
        hdr_14.ipv4.total_len = hdr_14.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_14.inner_ipv4.isValid() + hdr_14.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_14.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_14.inner_ipv6.isValid() + 16w50;
        ...
        hdr_14.udp.length = hdr_14.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_14.inner_ipv4.isValid() + hdr_14.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_14.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_14.inner_ipv6.isValid() + 16w30;
    ...
    @name(".nvgre_encap") action nvgre_encap_0() {
        ...
        hdr_15.ipv4.total_len = hdr_15.inner_ipv4.total_len * (bit<16>)(bit<1>)hdr_15.inner_ipv4.isValid() + hdr_15.inner_ipv6.payload_length * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w40 * (bit<16>)(bit<1>)hdr_15.inner_ipv6.isValid() + 16w42;
