...
control MyIC(inout headers_t hdr, inout user_meta_t b, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @hidden action psahash05l55() {
        var_0 = 16w0;
    }
    @hidden table tbl_psahash05l55 {
        actions = {
            psahash05l55();
        }
        const default_action = psahash05l55();
    }
    apply {
        tbl_psahash05l55.apply();
        tbl_0.apply();
    }
}
