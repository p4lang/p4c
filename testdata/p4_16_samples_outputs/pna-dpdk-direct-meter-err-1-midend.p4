...
control MainControlImpl(inout headers_t hdr, inout main_metadata_t user_meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @hidden action pnadpdkdirectmetererr1l144() {
        tmp_2 = 32w1;
    }
    @hidden action pnadpdkdirectmetererr1l144_0() {
        tmp_2 = 32w0;
    }
    @hidden action pnadpdkdirectmetererr1l143() {
        color_out_0 = meter1_0.execute(PNA_MeterColor_t.RED, 32w1024);
    }
    @hidden action pnadpdkdirectmetererr1l144_1() {
        user_meta.port_out1 = tmp_2;
    }
    @hidden action pnadpdkdirectmetererr1l106() {
        color_in_0 = PNA_MeterColor_t.RED;
    }
    @hidden table tbl_pnadpdkdirectmetererr1l106 {
        actions = {
            pnadpdkdirectmetererr1l106();
        }
        const default_action = pnadpdkdirectmetererr1l106();
    }
    ...
    @hidden table tbl_pnadpdkdirectmetererr1l144 {
        actions = {
            pnadpdkdirectmetererr1l144();
        }
        const default_action = pnadpdkdirectmetererr1l144();
    }
    @hidden table tbl_pnadpdkdirectmetererr1l144_0 {
        actions = {
            pnadpdkdirectmetererr1l144_0();
        }
        const default_action = pnadpdkdirectmetererr1l144_0();
    }
    @hidden table tbl_pnadpdkdirectmetererr1l144_1 {
        actions = {
            pnadpdkdirectmetererr1l144_1();
        }
        const default_action = pnadpdkdirectmetererr1l144_1();
    }
    apply {
        tbl_pnadpdkdirectmetererr1l106.apply();
        if (hdr.ipv4.isValid()) {
            tbl_pnadpdkdirectmetererr1l143.apply();
            if (color_out_0 == PNA_MeterColor_t.GREEN) {
                tbl_pnadpdkdirectmetererr1l144.apply();
            } else {
                tbl_pnadpdkdirectmetererr1l144_0.apply();
            }
            tbl_pnadpdkdirectmetererr1l144_1.apply();
            ipv4_da_lpm_0.apply();
...
control MainDeparserImpl(packet_out pkt, in headers_t hdr, in main_metadata_t user_meta, in pna_main_output_metadata_t ostd) {
    @hidden action pnadpdkdirectmetererr1l157() {
        pkt.emit<ethernet_t>(hdr.ethernet);
        pkt.emit<ipv4_t>(hdr.ipv4);
    }
    @hidden table tbl_pnadpdkdirectmetererr1l157 {
        actions = {
            pnadpdkdirectmetererr1l157();
        }
        const default_action = pnadpdkdirectmetererr1l157();
    }
    apply {
        tbl_pnadpdkdirectmetererr1l157.apply();
    }
}
