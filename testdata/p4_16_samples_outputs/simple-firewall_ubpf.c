/* Automatically generated by p4c-ubpf from ../examples/simple-firewall.p4 on Tue Jan 28 15:51:23 2020
 */
        ...
        uint32_t* tmp_0;
        {
            ...
            if (headers.tcp.ebpf_valid) {
                ...
                if ((headers.ipv4.srcAddr < headers.ipv4.dstAddr)) {
                    ...
                    hash_key_instance.field_0 = headers.ipv4.srcAddr;
                    hash_key_instance.field_1 = headers.ipv4.dstAddr;
                    ...
                    hash_key_instance_0.field_0 = headers.ipv4.dstAddr;
                    hash_key_instance_0.field_1 = headers.ipv4.srcAddr;
