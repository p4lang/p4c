...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @hidden action gauntlet_header_init35() {
        tmp1_0.setValid();
        tmp1_0.dst_addr = 48w1;
        tmp1_0.src_addr = 48w1;
        tmp1_0.eth_type = 16w1;
        h.eth_hdr1 = tmp1_0;
        tmp2_0.setValid();
    ...
    @hidden table tbl_gauntlet_header_init35 {
        actions = {
            gauntlet_header_init35();
        }
        const default_action = gauntlet_header_init35();
    }
    apply {
        tbl_gauntlet_header_init35.apply();
    }
}
