...
struct metadata_t {
	...
	bit<8> IngressParser_p_10
	bit<32> IngressParser_p_11
	bit<8> IngressParser_p_12
	bit<32> IngressParser_p_13
	bit<32> Ingress_tmp
	...
	bit<32> Ingress_color_o_14
	bit<32> Ingress_color_i_15
...
action execute_1 args instanceof execute_1_arg_t {
	...
	meter meter0_0 t.index h.ipv4.totalLen m.Ingress_color_i_15 m.Ingress_color_o_14
	jmpneq LABEL_FALSE_2 m.Ingress_color_o_14 0x0
	mov m.Ingress_tmp_10 0x1
	jmp LABEL_END_3
	LABEL_FALSE_2 :	mov m.Ingress_tmp_10 0x0
	LABEL_END_3 :	mov m.local_metadata__9 m.Ingress_tmp_10
...
apply {
	...
	shr m.IngressParser_p_10 0x4
	mov m.IngressParser_p_11 m.IngressParser_p_10
	jmpeq LABEL_TRUE m.IngressParser_p_11 0x5
	mov m.IngressParser_p_12 0x0
	jmp LABEL_END
	LABEL_TRUE :	mov m.IngressParser_p_12 0x1
	LABEL_END :	jmpneq LABEL_END_0 m.IngressParser_p_12 0
	mov m.psa_ingress_i_16 0x7
	jmp INGRESSPARSERIMPL_ACCEPT
	LABEL_END_0 :	mov m.IngressParser_p_13 h.ipv4.version_ihl
	INGRESSPARSERIMPL_ACCEPT :	mov m.Ingress_color_i_15 0x2
	jmpneq LABEL_END_1 m.local_metadata__9 0x1
	table tbl
	...
	LABEL_END_1 :	jmpneq LABEL_DROP m.psa_ingress_out_7 0x0
