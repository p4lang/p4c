...
struct user_meta_t {
	...
	bit<32> Ingress_as_grou_11
	bit<32> Ingress_as_memb_12
}
...
action tbl_set_group_i_13 args instanceof tbl_set_group_i_5 {
	mov m.Ingress_as_grou_11 t.group_id
	return
}
...
apply {
	...
	extract h.ethernet
	mov m.Ingress_as_memb_12 0x0
	mov m.Ingress_as_grou_11 0x0
	table tbl
	table as_sel
	table as
