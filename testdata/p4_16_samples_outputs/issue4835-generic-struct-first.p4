...
parser MyParser(packet_in pkt, out headers_t_bit8 hdr, inout meta_t meta, inout std_meta_t std_meta) {
    state start {
...
control MyIngress(inout headers_t_bit8 hdr, inout meta_t meta, inout std_meta_t std_meta) {
    apply {
    }
}

control MyEgress(inout headers_t_bit8 hdr, inout meta_t meta, inout std_meta_t std_meta) {
    apply {
    }
}
