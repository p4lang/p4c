...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    ethernet_t val1_0_inlined_dummy2_eth_hdr;
    ethernet_t val_0_inlined_dummy_eth_hdr;
    @name("ingress.simple_action") action simple_action() {
        ...
        if (hasReturned) {
            ...
            val1_0_inlined_dummy2_eth_hdr = h.eth_hdr;
            val_0_inlined_dummy_eth_hdr = h.eth_hdr;
            val_0_inlined_dummy_eth_hdr.eth_type = 16w0;
            val_0_inlined_dummy_eth_hdr.eth_type = 16w2;
            val_0_inlined_dummy_eth_hdr.eth_type = 16w5;
            val1_0_inlined_dummy2_eth_hdr = val_0_inlined_dummy_eth_hdr;
            val1_0_inlined_dummy2_eth_hdr.dst_addr = 48w3;
            h.eth_hdr = val1_0_inlined_dummy2_eth_hdr;
        }
    }
