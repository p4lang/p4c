...
control MainControlImpl(inout headers_t hdr, inout main_metadata_t meta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @name("MainControlImpl.tmp_1") bit<32> tmp;
    @name("MainControlImpl.tmp_2") bit<32> tmp_0;
    @name("MainControlImpl.tmp_3") bit<32> tmp_1;
    @name("MainControlImpl.tmp_4") bit<32> tmp_2;
    @name("MainControlImpl.tmp_5") bit<8> tmp_3;
    @name("MainControlImpl.tmp_6") bit<16> tmp_4;
    @name("MainControlImpl.tmp_7") bit<16> tmp_5;
    @name("MainControlImpl.tmp_8") bit<16> tmp_6;
    @name("MainControlImpl.tmp_9") bit<16> tmp_7;
    @name("MainControlImpl.tmp_10") tuple<bit<32>, bit<32>, bit<8>, bit<16>, bit<16>> tmp_8;
    @name("MainControlImpl.replyHash_0") bit<32> replyHash;
    ...
    @name("MainControlImpl.tmp_0") bool tmp_10;
    @name("MainControlImpl.tcp_flags_0") bit<8> tcp_flags;
    ...
    apply {
        ...
        if (hdr.tcp.isValid()) {
            ...
            tmp_6 = tmp_7;
            tmp_8 = { tmp, tmp_1, tmp_3, tmp_4, tmp_6 };
            meta.connHashCode = tcp5TupleHash.get_hash<tuple<bit<32>, bit<32>, bit<8>, bit<16>, bit<16>>>(tmp_8);
            replyHash = meta.replyHashCode;
            hasReturned = false;
            tmp_9 = tcpCtDirReg.read(replyHash);
            tmp_10 = tmp_9 == 8w0x0;
            if (tmp_10) {
                hasReturned = true;
                retval = 8w0x1;
            ...
            if (hasReturned_0) {
                ;
            } else if (tcp_flags & 8w0x1 != 8w0) {
                hasReturned_0 = true;
                retval_0 = 8w0x3;
            }
            if (hasReturned_0) {
                ;
            } else if (tcp_flags & 8w0x10 != 8w0) {
                hasReturned_0 = true;
                retval_0 = 8w0x4;
            }
            if (hasReturned_0) {
