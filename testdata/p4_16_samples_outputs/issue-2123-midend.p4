...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    state start {
        ...
        transition select(hdr.ethernet.etherType, hdr.ethernet.srcAddr[7:0], hdr.ethernet.dstAddr[7:0]) {
            (16w0x800 &&& 16w0xfffc, 8w0x8 &&& 8w0xf8, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x800 &&& 16w0xfffc, 8w0x8 &&& 8w0xf8, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x800 &&& 16w0xfffc, 8w0x10 &&& 8w0xfe, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x800 &&& 16w0xfffc, 8w0x10 &&& 8w0xfe, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x804 &&& 16w0xfffe, 8w0x8 &&& 8w0xf8, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x804 &&& 16w0xfffe, 8w0x8 &&& 8w0xf8, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x804 &&& 16w0xfffe, 8w0x10 &&& 8w0xfe, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x804 &&& 16w0xfffe, 8w0x10 &&& 8w0xfe, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x806 &&& 16w0xffff, 8w0x8 &&& 8w0xf8, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x806 &&& 16w0xffff, 8w0x8 &&& 8w0xf8, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x806 &&& 16w0xffff, 8w0x10 &&& 8w0xfe, 8w0x8 &&& 8w0xf8): parse_ipv4;
            (16w0x806 &&& 16w0xffff, 8w0x10 &&& 8w0xfe, 8w0x10 &&& 8w0xff): parse_ipv4;
            (16w0x800, 8w0x8 &&& 8w0xf8, 8w0x6 &&& 8w0x11): parse_ipv4;
            (16w0x800, 8w0x10 &&& 8w0xff, 8w0x6 &&& 8w0x11): parse_ipv4;
            default: accept;
        }
    }
    state noMatch {
