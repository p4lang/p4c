...
control ingress(inout Headers h, inout Meta m, inout standard_metadata_t sm) {
    ...
    @hidden action gauntlet_enum_assign15() {
        sm.egress_spec = 9w2;
    }
    @hidden table tbl_gauntlet_enum_assign15 {
        actions = {
            gauntlet_enum_assign15();
        }
        const default_action = gauntlet_enum_assign15();
    }
    ...
    apply {
        tbl_gauntlet_enum_assign15.apply();
        tbl_do_thing.apply();
    }
}
