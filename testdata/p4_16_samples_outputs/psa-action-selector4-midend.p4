...
control MyID(packet_out buffer, out EMPTY a, out EMPTY b, out EMPTY c, inout headers_t hdr, in user_meta_t e, in psa_ingress_output_metadata_t f) {
    @hidden action psaactionselector4l113() {
        buffer.emit<ethernet_t>(hdr.ethernet);
    }
    @hidden table tbl_psaactionselector4l113 {
        actions = {
            psaactionselector4l113();
        }
        const default_action = psaactionselector4l113();
    }
    apply {
        tbl_psaactionselector4l113.apply();
    }
}
