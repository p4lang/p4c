...
control MyID(packet_out buffer, out EMPTY a, out EMPTY b, out EMPTY c, inout headers_t hdr, in user_meta_t e, in psa_ingress_output_metadata_t f) {
    @hidden action psaactionselector4l107() {
        buffer.emit<ethernet_t>(hdr.ethernet);
    }
    @hidden table tbl_psaactionselector4l107 {
        actions = {
            psaactionselector4l107();
        }
        const default_action = psaactionselector4l107();
    }
    apply {
        tbl_psaactionselector4l107.apply();
    }
}
