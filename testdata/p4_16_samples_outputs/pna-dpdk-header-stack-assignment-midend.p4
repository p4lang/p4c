...
control MainControlImpl(inout parsed_headers_t hdrs, inout user_meta_t umeta, in pna_main_input_metadata_t istd, inout pna_main_output_metadata_t ostd) {
    ...
    @name("MainControlImpl.decap_one_tunnel_layer_just_before_eth") action decap_one_tunnel_layer_just_before_eth() {
    }
    @name("MainControlImpl.header_mod") table header_mod_0 {
        key = {
