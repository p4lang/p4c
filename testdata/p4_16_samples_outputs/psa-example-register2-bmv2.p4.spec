...
apply {
	...
	shl m.Ingress_tmp_2 0x30
	mov m.Ingress_tmp_3 m.Ingress_tmp_2
	and m.Ingress_tmp_3 0xffffffff000000000000
	mov m.Ingress_s_0 m.Ingress_tmp
	or m.Ingress_s_0 m.Ingress_tmp_3
	mov m.Ingress_tmp_4 m.Ingress_s_0
	and m.Ingress_tmp_4 0xffffffff000000000000
	mov m.Ingress_tmp_5 h.ipv4.totalLen
	mov m.Ingress_tmp_6 m.Ingress_tmp_5
	and m.Ingress_tmp_6 0xffffffffffff
	mov m.Ingress_s_0 m.Ingress_tmp_4
