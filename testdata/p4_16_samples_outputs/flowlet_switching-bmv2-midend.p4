...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("set_ecmp_select") action set_ecmp_select_0(bit<8> ecmp_base, bit<8> ecmp_count) {
        ...
        hash<bit<14>, bit<10>, tuple_0, bit<20>>(tmp_14, HashAlgorithm.crc16, (bit<10>)ecmp_base, tmp_15, (bit<20>)ecmp_count);
    ...
    @name("lookup_flowlet_map") action lookup_flowlet_map_0() {
        ...
        hash<bit<13>, bit<13>, tuple_1, bit<26>>(tmp_17, HashAlgorithm.crc16, 13w0, tmp_18, 26w13);
