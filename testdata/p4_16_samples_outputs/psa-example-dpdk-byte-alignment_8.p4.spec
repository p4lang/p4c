...
struct ipv4_t {
	...
	bit<32> _dstAddr11
	bit<8> _s1_f112
	bit<8> _s1_f213__s2_f1_2
	bit<8> _s2_f215
}

struct psa_ingress_out_3 {
	bit<8> class_of_servic_4
	bit<8> clone
	bit<16> clone_session_i_5
	bit<8> drop
	bit<8> resubmit
...
struct psa_egress_outp_6 {
	bit<8> clone
	bit<16> clone_session_i_5
	bit<8> drop
}

struct psa_egress_depa_7 {
	bit<32> egress_port
}
...
struct metadata_t {
	bit<32> psa_ingress_inp_8
	bit<8> psa_ingress_out_9
	bit<32> psa_ingress_out_10
	bit<32> local_metadata__11
	bit<32> local_metadata__12
	bit<8> IngressParser_p_13
	bit<32> IngressParser_p_14
	bit<8> IngressParser_p_15
	bit<32> IngressParser_p_16
	bit<32> Ingress_tmp
	...
	bit<32> Ingress_color_o_17
	bit<32> Ingress_color_i_18
...
action execute_1 args instanceof execute_1_arg_t {
	...
	meter meter0_0 t.index h.ipv4._totalLen3 m.Ingress_color_i_18 m.Ingress_color_o_17
	jmpneq LABEL_FALSE_2 m.Ingress_color_o_17 0x0
	mov m.Ingress_tmp_12 0x1
	jmp LABEL_END_3
	LABEL_FALSE_2 :	mov m.Ingress_tmp_12 0x0
	LABEL_END_3 :	mov m.local_metadata__11 m.Ingress_tmp_12
	regwr reg_0 t.index m.local_metadata__11
	...
	LABEL_END_4 :	jmpneq LABEL_FALSE_4 m.local_metadata__12 0x6
	mov h.ipv4._s1_f112 0x2
	mov m.Ingress_tmp_3 h.ipv4._s1_f213__s2_f1_2
	and m.Ingress_tmp_3 0xf8
	mov h.ipv4._s1_f213__s2_f1_2 m.Ingress_tmp_3
	or h.ipv4._s1_f213__s2_f1_2 0x3
	mov m.Ingress_tmp_4 h.ipv4._s1_f213__s2_f1_2
	and m.Ingress_tmp_4 0x7
	mov h.ipv4._s1_f213__s2_f1_2 m.Ingress_tmp_4
	or h.ipv4._s1_f213__s2_f1_2 0x10
	mov h.ipv4._s2_f215 0x3
	jmp LABEL_END_5
	LABEL_FALSE_4 :	mov h.ipv4._s1_f112 0x3
	mov m.Ingress_tmp_5 h.ipv4._s1_f213__s2_f1_2
	and m.Ingress_tmp_5 0xf8
	mov h.ipv4._s1_f213__s2_f1_2 m.Ingress_tmp_5
	or h.ipv4._s1_f213__s2_f1_2 0x2
	mov m.Ingress_tmp_6 h.ipv4._s1_f213__s2_f1_2
	and m.Ingress_tmp_6 0x7
	mov h.ipv4._s1_f213__s2_f1_2 m.Ingress_tmp_6
	or h.ipv4._s1_f213__s2_f1_2 0x18
...
apply {
	...
	mov m.IngressParser_p_13 h.ipv4._version0__ihl1
	shr m.IngressParser_p_13 0x4
	mov m.IngressParser_p_14 m.IngressParser_p_13
	jmpeq LABEL_TRUE m.IngressParser_p_14 0x5
	mov m.IngressParser_p_15 0x0
	jmp LABEL_END
	LABEL_TRUE :	mov m.IngressParser_p_15 0x1
	LABEL_END :	jmpneq LABEL_END_0 m.IngressParser_p_15 0
	mov m.psa_ingress_i_19 0x7
	jmp INGRESSPARSERIMPL_ACCEPT
	LABEL_END_0 :	mov m.IngressParser_p_16 h.ipv4._version0__ihl1
	INGRESSPARSERIMPL_ACCEPT :	mov m.Ingress_color_i_18 0x2
	jmpneq LABEL_END_1 m.local_metadata__11 0x1
	table tbl
	regadd counter0_0_packets 0x3ff 1
	regadd counter0_0_bytes 0x3ff 0x14
	regadd counter1_0 0x200 1
	regadd counter2_0 0x3ff 0x40
	regrd m.local_metadata__11 reg_0 0x1
	...
	LABEL_END_1 :	jmpneq LABEL_DROP m.psa_ingress_out_9 0x0
