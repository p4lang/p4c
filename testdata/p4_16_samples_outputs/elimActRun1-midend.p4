...
control ingress(inout Headers h) {
    ...
    @hidden action elimActRun1l25() {
        hasReturned = false;
        key_0 = 48w1;
    }
    @hidden action elimActRun1l33() {
        key_1 = 48w1;
    }
    @hidden action elimActRun1l44() {
        h.eth_hdr.src_addr = 48w4;
        hasReturned = true;
    }
    @hidden table tbl_elimActRun1l25 {
        actions = {
            elimActRun1l25();
        }
        const default_action = elimActRun1l25();
    }
    @hidden table tbl_elimActRun1l33 {
        actions = {
            elimActRun1l33();
        }
        const default_action = elimActRun1l33();
    }
    @hidden table tbl_elimActRun1l44 {
        actions = {
            elimActRun1l44();
        }
        const default_action = elimActRun1l44();
    }
    apply {
        tbl_elimActRun1l25.apply();
        simple_table.apply();
        switch (simple_table_action_run) {
            simple_table_action_run_t.simple_table_dummy_action: {
                tbl_elimActRun1l33.apply();
                simple_table_0.apply();
                switch (simple_table_0_action_run) {
                    simple_table_0_action_run_t.simple_table_0_dummy_action: {
                        tbl_elimActRun1l44.apply();
                    }
                    default: {
                    }
                }
