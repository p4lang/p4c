...
header MainParserT_parser_tmp instanceof option_t
...
apply {
	...
	jmp MAINPARSERIMPL_ACCEPT
	MAINPARSERIMPL_PARSE_IPV4_OPTION_TIMESTAMP :	lookahead h.MainParserT_parser_tmp
	mov m.varbit_extract_tmp 0x10
	shr m.varbit_extract_tmp 0x3
	extract h.ipv4_option_timestamp m.varbit_extract_tmp
