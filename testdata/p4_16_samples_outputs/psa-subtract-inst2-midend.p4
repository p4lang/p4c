...
control MyIngressControl(inout headers_t hdrs, inout user_meta_data_t meta, in psa_ingress_input_metadata_t c, inout psa_ingress_output_metadata_t d) {
    ...
    @name("MyIngressControl.nonDefAct") action nonDefAct() {
        meta.depth1 = (var4_0 == 3s3 ? var1_0 + var2_0 : meta.depth1);
    }
    ...
    @hidden action psasubtractinst2l58() {
        var1_0 = 3w0;
        var2_0 = 3w2;
        var4_0 = var3_0 + -3s3;
        d.egress_port = (bit<32>)c.ingress_port ^ 32w1;
    }
    @hidden table tbl_psasubtractinst2l58 {
        actions = {
            psasubtractinst2l58();
        }
        const default_action = psasubtractinst2l58();
    }
    apply {
        tbl_psasubtractinst2l58.apply();
        stub_0.apply();
    }
}
...
control MyIngressDeparser(packet_out pkt, out EMPTY a, out EMPTY b, out EMPTY c, inout headers_t hdr, in user_meta_data_t e, in psa_ingress_output_metadata_t f) {
    @hidden action psasubtractinst2l93() {
        pkt.emit<ethernet_t>(hdr.ethernet);
    }
    @hidden table tbl_psasubtractinst2l93 {
        actions = {
            psasubtractinst2l93();
        }
        const default_action = psasubtractinst2l93();
    }
    apply {
        tbl_psasubtractinst2l93.apply();
    }
}
