...
#define EXPIRE_TIME_PROFILE_TCP_NOW ((ExpireTimeProfileId_t) 0)
#define EXPIRE_TIME_PROFILE_TCP_NEW ((ExpireTimeProfileId_t) 1)
#define EXPIRE_TIME_PROFILE_TCP_ESTABLISHED ((ExpireTimeProfileId_t) 2)
#define EXPIRE_TIME_PROFILE_TCP_NEVER ((ExpireTimeProfileId_t) 3)
    ...
    inout pna_main_output_metadata_t ostd)
{
    ...
    table set_ct_options {
        ...
        actions = {
            @default_hit_const tcp_syn_packet;
            @default_hit_const tcp_fin_or_rst_packet;
            tcp_other_packets;
        }
