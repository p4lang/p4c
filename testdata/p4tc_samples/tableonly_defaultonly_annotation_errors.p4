    ...
    inout pna_main_output_metadata_t ostd)
{
    ...
    table set_ct_options {
        ...
        actions = {
            @tableonly @defaultonly tcp_syn_packet;
    ...
    table set_all_options {
        ...
        const entries = {
            (0x1000, 1, 10) : tcp_syn_packet;
            (0x2000, 2, 20) : tcp_fin_or_rst_packet;
            (0x3000, 3, 30) : tcp_fin_or_rst_packet;
            (0x4000, 4, 40) : default_route_drop;
            (0x5000, 5, 50) : next_hop(hport);
            (0x6000, 6, 60) : sendtoport(nport);
        }
