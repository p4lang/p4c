...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_ipv4") state parse_ipv4 {
        ...
        meta.my_metadata.parse_ipv4_counter = (bit<8>)((hdr.ipv4_base.ihl << 2) - 4w4);
    ...
    @name(".parse_ipv4_option_timestamp") state parse_ipv4_option_timestamp {
        tmp_hdr_0 = packet.lookahead<ipv4_option_timestamp_t_1>();
        packet.extract<ipv4_option_timestamp_t>(hdr.ipv4_option_timestamp, ((bit<32>)tmp_hdr_0.len << 3) - 32w16);
    ...
    @name(".parse_ipv4_options") state parse_ipv4_options {
        tmp = meta.my_metadata.parse_ipv4_counter;
