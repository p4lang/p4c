...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("parse_head") state parse_head {
        ...
        meta.my_metadata.headerLen = 8w2 + hdr.axon_head.fwdHopCount + hdr.axon_head.revHopCount;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("route") action route() {
        standard_metadata.egress_spec = hdr.axon_fwdHop[0].port;
        ...
        hdr.axon_revHop[0].port = standard_metadata.ingress_port;
    }
