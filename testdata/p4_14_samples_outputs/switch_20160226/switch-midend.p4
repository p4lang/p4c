...
struct metadata {
    ...
    bit<32>  _ipv4_metadata_lkp_ipv4_sa53;
    bit<32>  _ipv4_metadata_lkp_ipv4_da54;
    bit<1>   _ipv4_metadata_ipv4_unicast_enabled55;
    bit<2>   _ipv4_metadata_ipv4_urpf_mode56;
    bit<128> _ipv6_metadata_lkp_ipv6_sa57;
    bit<128> _ipv6_metadata_lkp_ipv6_da58;
    bit<1>   _ipv6_metadata_ipv6_unicast_enabled59;
    bit<1>   _ipv6_metadata_ipv6_src_is_link_local60;
    bit<2>   _ipv6_metadata_ipv6_urpf_mode61;
    bit<3>   _l2_metadata_lkp_pkt_type62;
    bit<48>  _l2_metadata_lkp_mac_sa63;
    bit<48>  _l2_metadata_lkp_mac_da64;
    bit<16>  _l2_metadata_lkp_mac_type65;
    bit<16>  _l2_metadata_l2_nexthop66;
    bit<1>   _l2_metadata_l2_nexthop_type67;
    bit<1>   _l2_metadata_l2_redirect68;
    bit<1>   _l2_metadata_l2_src_miss69;
    bit<16>  _l2_metadata_l2_src_move70;
    bit<10>  _l2_metadata_stp_group71;
    bit<3>   _l2_metadata_stp_state72;
    bit<16>  _l2_metadata_bd_stats_idx73;
    bit<1>   _l2_metadata_learning_enabled74;
    bit<1>   _l2_metadata_port_vlan_mapping_miss75;
    bit<16>  _l2_metadata_same_if_check76;
    bit<2>   _l3_metadata_lkp_ip_type77;
    bit<4>   _l3_metadata_lkp_ip_version78;
    bit<8>   _l3_metadata_lkp_ip_proto79;
    bit<8>   _l3_metadata_lkp_ip_tc80;
    bit<8>   _l3_metadata_lkp_ip_ttl81;
    bit<16>  _l3_metadata_lkp_l4_sport82;
    bit<16>  _l3_metadata_lkp_l4_dport83;
    bit<16>  _l3_metadata_lkp_inner_l4_sport84;
    bit<16>  _l3_metadata_lkp_inner_l4_dport85;
    bit<12>  _l3_metadata_vrf86;
    bit<10>  _l3_metadata_rmac_group87;
    bit<1>   _l3_metadata_rmac_hit88;
    bit<2>   _l3_metadata_urpf_mode89;
    bit<1>   _l3_metadata_urpf_hit90;
    bit<1>   _l3_metadata_urpf_check_fail91;
    bit<16>  _l3_metadata_urpf_bd_group92;
    bit<1>   _l3_metadata_fib_hit93;
    bit<16>  _l3_metadata_fib_nexthop94;
    bit<1>   _l3_metadata_fib_nexthop_type95;
    bit<16>  _l3_metadata_same_bd_check96;
    bit<16>  _l3_metadata_nexthop_index97;
    bit<1>   _l3_metadata_routed98;
    bit<1>   _l3_metadata_outer_routed99;
    bit<8>   _l3_metadata_mtu_index100;
    bit<16>  _l3_metadata_l3_mtu_check101;
    bit<1>   _multicast_metadata_ip_multicast102;
    bit<1>   _multicast_metadata_igmp_snooping_enabled103;
    bit<1>   _multicast_metadata_mld_snooping_enabled104;
    bit<1>   _multicast_metadata_inner_replica105;
    bit<1>   _multicast_metadata_replica106;
    bit<16>  _multicast_metadata_mcast_grp107;
    bit<1>   _nexthop_metadata_nexthop_type108;
    bit<8>   _qos_metadata_outer_dscp109;
    bit<3>   _qos_metadata_marked_cos110;
    bit<8>   _qos_metadata_marked_dscp111;
    bit<3>   _qos_metadata_marked_exp112;
    bit<48>  _queueing_metadata_enq_timestamp113;
    bit<16>  _queueing_metadata_enq_qdepth114;
    bit<32>  _queueing_metadata_deq_timedelta115;
    bit<16>  _queueing_metadata_deq_qdepth116;
    bit<1>   _security_metadata_storm_control_color117;
    bit<1>   _security_metadata_ipsg_enabled118;
    bit<1>   _security_metadata_ipsg_check_fail119;
    bit<5>   _tunnel_metadata_ingress_tunnel_type120;
    bit<24>  _tunnel_metadata_tunnel_vni121;
    bit<1>   _tunnel_metadata_mpls_enabled122;
    bit<20>  _tunnel_metadata_mpls_label123;
    bit<3>   _tunnel_metadata_mpls_exp124;
    bit<8>   _tunnel_metadata_mpls_ttl125;
    bit<5>   _tunnel_metadata_egress_tunnel_type126;
    bit<14>  _tunnel_metadata_tunnel_index127;
    bit<9>   _tunnel_metadata_tunnel_src_index128;
    bit<9>   _tunnel_metadata_tunnel_smac_index129;
    bit<14>  _tunnel_metadata_tunnel_dst_index130;
    bit<14>  _tunnel_metadata_tunnel_dmac_index131;
    bit<24>  _tunnel_metadata_vnid132;
    bit<1>   _tunnel_metadata_tunnel_terminate133;
    bit<1>   _tunnel_metadata_tunnel_if_check134;
    bit<4>   _tunnel_metadata_egress_header_count135;
}
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_eompls") state parse_eompls {
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w6;
    ...
    @name(".parse_ethernet") state parse_ethernet {
        ...
        meta._l2_metadata_lkp_mac_sa63 = hdr.ethernet.srcAddr;
        meta._l2_metadata_lkp_mac_da64 = hdr.ethernet.dstAddr;
    ...
    @name(".parse_geneve") state parse_geneve {
        ...
        meta._tunnel_metadata_tunnel_vni121 = hdr.genv.vni;
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w4;
    ...
    @name(".parse_gre_ipv4") state parse_gre_ipv4 {
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w2;
    ...
    @name(".parse_icmp") state parse_icmp {
        ...
        meta._l3_metadata_lkp_l4_sport82 = hdr.icmp.typeCode;
    ...
    @name(".parse_inner_icmp") state parse_inner_icmp {
        ...
        meta._l3_metadata_lkp_inner_l4_sport84 = hdr.inner_icmp.typeCode;
        transition accept;
    }
    ...
    @name(".parse_inner_tcp") state parse_inner_tcp {
        ...
        meta._l3_metadata_lkp_inner_l4_sport84 = hdr.inner_tcp.srcPort;
        meta._l3_metadata_lkp_inner_l4_dport85 = hdr.inner_tcp.dstPort;
        transition accept;
    }
    @name(".parse_inner_udp") state parse_inner_udp {
        packet.extract<udp_t>(hdr.inner_udp);
        meta._l3_metadata_lkp_inner_l4_sport84 = hdr.inner_udp.srcPort;
        meta._l3_metadata_lkp_inner_l4_dport85 = hdr.inner_udp.dstPort;
        transition accept;
    }
    ...
    @name(".parse_ipv4") state parse_ipv4 {
        ...
        meta._ipv4_metadata_lkp_ipv4_sa53 = hdr.ipv4.srcAddr;
        meta._ipv4_metadata_lkp_ipv4_da54 = hdr.ipv4.dstAddr;
        meta._l3_metadata_lkp_ip_proto79 = hdr.ipv4.protocol;
        meta._l3_metadata_lkp_ip_ttl81 = hdr.ipv4.ttl;
    ...
    @name(".parse_ipv4_in_ip") state parse_ipv4_in_ip {
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w3;
        transition parse_inner_ipv4;
    }
    @name(".parse_ipv6") state parse_ipv6 {
        packet.extract<ipv6_t>(hdr.ipv6);
        meta._ipv6_metadata_lkp_ipv6_sa57 = hdr.ipv6.srcAddr;
        meta._ipv6_metadata_lkp_ipv6_da58 = hdr.ipv6.dstAddr;
        meta._l3_metadata_lkp_ip_proto79 = hdr.ipv6.nextHdr;
        meta._l3_metadata_lkp_ip_ttl81 = hdr.ipv6.hopLimit;
    ...
    @name(".parse_mpls_inner_ipv4") state parse_mpls_inner_ipv4 {
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w9;
        transition parse_inner_ipv4;
    }
    ...
    @name(".parse_nvgre") state parse_nvgre {
        ...
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w5;
        meta._tunnel_metadata_tunnel_vni121 = hdr.nvgre.tni;
        transition parse_inner_ethernet;
    }
    ...
    @name(".parse_tcp") state parse_tcp {
        ...
        meta._l3_metadata_lkp_l4_sport82 = hdr.tcp.srcPort;
        meta._l3_metadata_lkp_l4_dport83 = hdr.tcp.dstPort;
    ...
    @name(".parse_udp") state parse_udp {
        ...
        meta._l3_metadata_lkp_l4_sport82 = hdr.udp.srcPort;
        meta._l3_metadata_lkp_l4_dport83 = hdr.udp.dstPort;
    ...
    @name(".parse_vxlan") state parse_vxlan {
        ...
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w1;
        meta._tunnel_metadata_tunnel_vni121 = hdr.vxlan.vni;
        transition parse_inner_ethernet;
    }
    @name(".parse_vxlan_gpe") state parse_vxlan_gpe {
        packet.extract<vxlan_gpe_t>(hdr.vxlan_gpe);
        meta._tunnel_metadata_ingress_tunnel_type120 = 5w12;
        meta._tunnel_metadata_tunnel_vni121 = hdr.vxlan_gpe.vni;
...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".outer_replica_from_rid") action _outer_replica_from_rid_0(bit<16> bd, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta._egress_metadata_bd19 = bd;
        meta._multicast_metadata_replica106 = 1w1;
        meta._multicast_metadata_inner_replica105 = 1w0;
        meta._egress_metadata_routed22 = meta._l3_metadata_routed98;
        meta._egress_metadata_same_bd_check23 = bd ^ meta._ingress_metadata_bd40;
        meta._tunnel_metadata_tunnel_index127 = tunnel_index;
        meta._tunnel_metadata_egress_tunnel_type126 = tunnel_type;
    }
    @name(".outer_replica_from_rid_with_nexthop") action _outer_replica_from_rid_with_nexthop_0(bit<16> bd, bit<16> nexthop_index, bit<14> tunnel_index, bit<5> tunnel_type) {
        ...
        meta._multicast_metadata_replica106 = 1w1;
        meta._multicast_metadata_inner_replica105 = 1w0;
        meta._egress_metadata_routed22 = meta._l3_metadata_outer_routed99;
        meta._l3_metadata_nexthop_index97 = nexthop_index;
        meta._egress_metadata_same_bd_check23 = bd ^ meta._ingress_metadata_bd40;
        meta._tunnel_metadata_tunnel_index127 = tunnel_index;
        meta._tunnel_metadata_egress_tunnel_type126 = tunnel_type;
    }
    @name(".inner_replica_from_rid") action _inner_replica_from_rid_0(bit<16> bd, bit<14> tunnel_index, bit<5> tunnel_type) {
        meta._egress_metadata_bd19 = bd;
        meta._multicast_metadata_replica106 = 1w1;
        meta._multicast_metadata_inner_replica105 = 1w1;
        meta._egress_metadata_routed22 = meta._l3_metadata_routed98;
        meta._egress_metadata_same_bd_check23 = bd ^ meta._ingress_metadata_bd40;
        meta._tunnel_metadata_tunnel_index127 = tunnel_index;
        meta._tunnel_metadata_egress_tunnel_type126 = tunnel_type;
    ...
    @name(".replica_type") table _replica_type {
        ...
        key = {
            meta._multicast_metadata_replica106  : exact @name("multicast_metadata.replica") ;
    ...
    @name(".tunnel_decap_process_outer") table _tunnel_decap_process_outer {
        ...
        key = {
            meta._tunnel_metadata_ingress_tunnel_type120: exact @name("tunnel_metadata.ingress_tunnel_type") ;
    ...
    @name(".set_l3_rewrite") action _set_l3_rewrite_0(bit<16> bd, bit<8> mtu_index, bit<9> smac_idx, bit<48> dmac) {
        ...
        meta._l3_metadata_mtu_index100 = mtu_index;
    }
    ...
    @name(".set_mpls_swap_push_rewrite_l2") action _set_mpls_swap_push_rewrite_l2_0(bit<20> label, bit<14> tunnel_index, bit<4> header_count) {
        ...
        meta._tunnel_metadata_tunnel_index127 = tunnel_index;
        meta._tunnel_metadata_egress_header_count135 = header_count;
        meta._tunnel_metadata_egress_tunnel_type126 = 5w13;
    }
    ...
    @name(".set_mpls_swap_push_rewrite_l3") action _set_mpls_swap_push_rewrite_l3_0(bit<16> bd, bit<9> smac_idx, bit<48> dmac, bit<20> label, bit<14> tunnel_index, bit<4> header_count) {
        ...
        meta._tunnel_metadata_tunnel_index127 = tunnel_index;
        meta._tunnel_metadata_egress_header_count135 = header_count;
        meta._tunnel_metadata_egress_tunnel_type126 = 5w14;
    }
    ...
    @name(".rewrite") table _rewrite {
        ...
        key = {
            meta._l3_metadata_nexthop_index97: exact @name("l3_metadata.nexthop_index") ;
        }
        size = 1024;
    ...
    @name(".int_set_header_0003_i1") action _int_set_header_0003_i1_0() {
        ...
        hdr.int_q_occupancy_header.q_occupancy = (bit<31>)meta._queueing_metadata_enq_qdepth114;
    }
    @name(".int_set_header_0003_i2") action _int_set_header_0003_i2_0() {
        hdr.int_hop_latency_header.setValid();
        hdr.int_hop_latency_header.hop_latency = (bit<31>)meta._queueing_metadata_deq_timedelta115;
    }
    ...
    @name(".set_egress_tunnel_vni") action _set_egress_tunnel_vni_0(bit<24> vnid) {
        meta._tunnel_metadata_vnid132 = vnid;
    }
    ...
    @name(".ipv4_vxlan_rewrite") action _ipv4_vxlan_rewrite_0() {
        ...
        hdr.vxlan.vni = meta._tunnel_metadata_vnid132;
    ...
    @name(".ipv4_genv_rewrite") action _ipv4_genv_rewrite_0() {
        ...
        hdr.genv.vni = meta._tunnel_metadata_vnid132;
    ...
    @name(".ipv4_nvgre_rewrite") action _ipv4_nvgre_rewrite_0() {
        ...
        hdr.gre.S = 1w0;
        hdr.gre.s = 1w0;
        hdr.nvgre.tni = meta._tunnel_metadata_vnid132;
    ...
    @name(".set_tunnel_rewrite_details") action _set_tunnel_rewrite_details_0(bit<16> outer_bd, bit<8> mtu_index, bit<9> smac_idx, bit<14> dmac_idx, bit<9> sip_index, bit<14> dip_index) {
        ...
        meta._tunnel_metadata_tunnel_smac_index129 = smac_idx;
        meta._tunnel_metadata_tunnel_dmac_index131 = dmac_idx;
        meta._tunnel_metadata_tunnel_src_index128 = sip_index;
        meta._tunnel_metadata_tunnel_dst_index130 = dip_index;
        meta._l3_metadata_mtu_index100 = mtu_index;
    }
    ...
    @name(".fabric_unicast_rewrite") action _fabric_unicast_rewrite_0() {
        ...
        hdr.fabric_header_unicast.tunnelTerminate = meta._tunnel_metadata_tunnel_terminate133;
        hdr.fabric_header_unicast.routed = meta._l3_metadata_routed98;
        hdr.fabric_header_unicast.outerRouted = meta._l3_metadata_outer_routed99;
        hdr.fabric_header_unicast.ingressTunnelType = meta._tunnel_metadata_ingress_tunnel_type120;
        hdr.fabric_header_unicast.nexthopIndex = meta._l3_metadata_nexthop_index97;
        hdr.fabric_payload_header.setValid();
        hdr.fabric_payload_header.etherType = hdr.ethernet.etherType;
        hdr.ethernet.etherType = 16w0x9000;
    }
    @name(".fabric_multicast_rewrite") action _fabric_multicast_rewrite_0(bit<16> fabric_mgid) {
        ...
        hdr.fabric_header_multicast.tunnelTerminate = meta._tunnel_metadata_tunnel_terminate133;
        hdr.fabric_header_multicast.routed = meta._l3_metadata_routed98;
        hdr.fabric_header_multicast.outerRouted = meta._l3_metadata_outer_routed99;
        hdr.fabric_header_multicast.ingressTunnelType = meta._tunnel_metadata_ingress_tunnel_type120;
        hdr.fabric_header_multicast.mcastGrp = meta._multicast_metadata_mcast_grp107;
        hdr.fabric_payload_header.setValid();
        hdr.fabric_payload_header.etherType = hdr.ethernet.etherType;
        hdr.ethernet.etherType = 16w0x9000;
    }
    ...
    @name(".egress_vni") table _egress_vni {
        ...
        key = {
            meta._egress_metadata_bd19                 : exact @name("egress_metadata.bd") ;
            meta._tunnel_metadata_egress_tunnel_type126: exact @name("tunnel_metadata.egress_tunnel_type") ;
        }
        size = 1024;
    ...
    @name(".tunnel_dmac_rewrite") table _tunnel_dmac_rewrite {
        ...
        key = {
            meta._tunnel_metadata_tunnel_dmac_index131: exact @name("tunnel_metadata.tunnel_dmac_index") ;
        }
        size = 1024;
    ...
    @name(".tunnel_dst_rewrite") table _tunnel_dst_rewrite {
        ...
        key = {
            meta._tunnel_metadata_tunnel_dst_index130: exact @name("tunnel_metadata.tunnel_dst_index") ;
        }
        size = 1024;
    ...
    @name(".tunnel_encap_process_outer") table _tunnel_encap_process_outer {
        ...
        key = {
            meta._tunnel_metadata_egress_tunnel_type126 : exact @name("tunnel_metadata.egress_tunnel_type") ;
            meta._tunnel_metadata_egress_header_count135: exact @name("tunnel_metadata.egress_header_count") ;
            meta._multicast_metadata_replica106         : exact @name("multicast_metadata.replica") ;
        }
        size = 1024;
    ...
    @name(".tunnel_rewrite") table _tunnel_rewrite {
        ...
        key = {
            meta._tunnel_metadata_tunnel_index127: exact @name("tunnel_metadata.tunnel_index") ;
        }
        size = 1024;
    ...
    @name(".tunnel_smac_rewrite") table _tunnel_smac_rewrite {
        ...
        key = {
            meta._tunnel_metadata_tunnel_smac_index129: exact @name("tunnel_metadata.tunnel_smac_index") ;
        }
        size = 1024;
    ...
    @name(".tunnel_src_rewrite") table _tunnel_src_rewrite {
        ...
        key = {
            meta._tunnel_metadata_tunnel_src_index128: exact @name("tunnel_metadata.tunnel_src_index") ;
        }
        size = 1024;
    ...
    @name(".int_outer_encap") table _int_outer_encap {
        ...
        key = {
            ...
            meta._tunnel_metadata_egress_tunnel_type126: ternary @name("tunnel_metadata.egress_tunnel_type") ;
        }
        size = 8;
    ...
    @name(".egress_acl") table _egress_acl {
        ...
        key = {
            ...
            meta._l3_metadata_l3_mtu_check101: ternary @name("l3_metadata.l3_mtu_check") ;
        }
        size = 512;
        ...
        if (meta._egress_metadata_bypass15 == 1w0) {
            ...
            switch (egress_port_mapping_0.apply().action_run) {
                egress_port_type_normal: {
                    if (standard_metadata.instance_type == 32w0 || standard_metadata.instance_type == 32w5) 
                        _vlan_decap.apply();
                    if (meta._tunnel_metadata_tunnel_terminate133 == 1w1) 
                        if (meta._multicast_metadata_inner_replica105 == 1w1 || meta._multicast_metadata_replica106 == 1w0) {
            ...
            if (meta._fabric_metadata_fabric_header_present26 == 1w0 && meta._tunnel_metadata_egress_tunnel_type126 != 5w0) {
                _egress_vni.apply();
                if (meta._tunnel_metadata_egress_tunnel_type126 != 5w15 && meta._tunnel_metadata_egress_tunnel_type126 != 5w16) 
            ...
            _egress_lag.apply();
            if (meta._multicast_metadata_inner_replica105 == 1w1) 
                if (meta._tunnel_metadata_egress_tunnel_type126 != 5w0 && meta._egress_filter_metadata_inner_bd14 == 16w0 || meta._egress_filter_metadata_ifindex12 == 16w0 && meta._egress_filter_metadata_bd13 == 16w0) 
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".rmac_hit") action rmac_hit_1() {
        meta._l3_metadata_rmac_hit88 = 1w1;
    }
    @name(".rmac_miss") action rmac_miss() {
        meta._l3_metadata_rmac_hit88 = 1w0;
    }
    @name(".rmac") table rmac_0 {
        ...
        key = {
            meta._l3_metadata_rmac_group87: exact @name("l3_metadata.rmac_group") ;
            meta._l2_metadata_lkp_mac_da64: exact @name("l2_metadata.lkp_mac_da") ;
        }
        size = 1024;
    ...
    @name(".malformed_outer_ethernet_packet") action _malformed_outer_ethernet_packet_0(bit<8> drop_reason) {
        ...
        meta._l2_metadata_same_if_check76 = meta._ingress_metadata_ifindex36;
    }
    @name(".set_valid_outer_unicast_packet_untagged") action _set_valid_outer_unicast_packet_untagged_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w1;
        meta._l2_metadata_lkp_mac_type65 = hdr.ethernet.etherType;
        standard_metadata.egress_spec = 9w511;
        meta._i2e_metadata_ingress_tstamp33 = (bit<32>)standard_metadata.ingress_global_timestamp;
        meta._ingress_metadata_ingress_port35 = standard_metadata.ingress_port;
        meta._l2_metadata_same_if_check76 = meta._ingress_metadata_ifindex36;
    }
    @name(".set_valid_outer_unicast_packet_single_tagged") action _set_valid_outer_unicast_packet_single_tagged_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w1;
        meta._l2_metadata_lkp_mac_type65 = hdr.vlan_tag_[0].etherType;
        standard_metadata.egress_spec = 9w511;
        meta._i2e_metadata_ingress_tstamp33 = (bit<32>)standard_metadata.ingress_global_timestamp;
        meta._ingress_metadata_ingress_port35 = standard_metadata.ingress_port;
        meta._l2_metadata_same_if_check76 = meta._ingress_metadata_ifindex36;
    ...
    @name(".set_valid_outer_unicast_packet_double_tagged") action _set_valid_outer_unicast_packet_double_tagged_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w1;
        meta._l2_metadata_lkp_mac_type65 = hdr.vlan_tag_[1].etherType;
        standard_metadata.egress_spec = 9w511;
        meta._i2e_metadata_ingress_tstamp33 = (bit<32>)standard_metadata.ingress_global_timestamp;
        meta._ingress_metadata_ingress_port35 = standard_metadata.ingress_port;
        meta._l2_metadata_same_if_check76 = meta._ingress_metadata_ifindex36;
    ...
    @name(".set_valid_outer_multicast_packet_untagged") action _set_valid_outer_multicast_packet_untagged_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w2;
        meta._l2_metadata_lkp_mac_type65 = hdr.ethernet.etherType;
        standard_metadata.egress_spec = 9w511;
        meta._i2e_metadata_ingress_tstamp33 = (bit<32>)standard_metadata.ingress_global_timestamp;
        meta._ingress_metadata_ingress_port35 = standard_metadata.ingress_port;
    ...
    @name(".set_valid_outer_broadcast_packet_untagged") action _set_valid_outer_broadcast_packet_untagged_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w4;
        meta._l2_metadata_lkp_mac_type65 = hdr.ethernet.etherType;
        standard_metadata.egress_spec = 9w511;
        meta._i2e_metadata_ingress_tstamp33 = (bit<32>)standard_metadata.ingress_global_timestamp;
        meta._ingress_metadata_ingress_port35 = standard_metadata.ingress_port;
    ...
    @name(".validate_outer_ethernet") table _validate_outer_ethernet {
        ...
        key = {
            meta._l2_metadata_lkp_mac_sa63: ternary @name("l2_metadata.lkp_mac_sa") ;
            meta._l2_metadata_lkp_mac_da64: ternary @name("l2_metadata.lkp_mac_da") ;
            hdr.vlan_tag_[0].isValid()    : exact @name("vlan_tag_[0].$valid$") ;
            hdr.vlan_tag_[1].isValid()    : exact @name("vlan_tag_[1].$valid$") ;
        }
        size = 512;
    ...
    @name(".set_valid_outer_ipv4_packet") action _set_valid_outer_ipv4_packet() {
        meta._l3_metadata_lkp_ip_type77 = 2w1;
        meta._l3_metadata_lkp_ip_tc80 = hdr.ipv4.diffserv;
        meta._l3_metadata_lkp_ip_version78 = 4w4;
    }
    ...
    @name(".validate_outer_ipv4_packet") table _validate_outer_ipv4_packet_0 {
        ...
        key = {
            ...
            meta._l3_metadata_lkp_ip_ttl81          : ternary @name("l3_metadata.lkp_ip_ttl") ;
            meta._ipv4_metadata_lkp_ipv4_sa53[31:24]: ternary @name("ipv4_metadata.lkp_ipv4_sa") ;
        }
        size = 512;
        default_action = NoAction_117();
    }
    @name(".set_valid_outer_ipv6_packet") action _set_valid_outer_ipv6_packet() {
        meta._l3_metadata_lkp_ip_type77 = 2w2;
        meta._l3_metadata_lkp_ip_tc80 = hdr.ipv6.trafficClass;
        meta._l3_metadata_lkp_ip_version78 = 4w6;
    }
    ...
    @name(".validate_outer_ipv6_packet") table _validate_outer_ipv6_packet_0 {
        ...
        key = {
            ...
            meta._l3_metadata_lkp_ip_ttl81            : ternary @name("l3_metadata.lkp_ip_ttl") ;
            meta._ipv6_metadata_lkp_ipv6_sa57[127:112]: ternary @name("ipv6_metadata.lkp_ipv6_sa") ;
        }
        size = 512;
        default_action = NoAction_118();
    }
    @name(".set_valid_mpls_label1") action _set_valid_mpls_label1() {
        meta._tunnel_metadata_mpls_label123 = hdr.mpls[0].label;
        meta._tunnel_metadata_mpls_exp124 = hdr.mpls[0].exp;
    }
    @name(".set_valid_mpls_label2") action _set_valid_mpls_label2() {
        meta._tunnel_metadata_mpls_label123 = hdr.mpls[1].label;
        meta._tunnel_metadata_mpls_exp124 = hdr.mpls[1].exp;
    }
    @name(".set_valid_mpls_label3") action _set_valid_mpls_label3() {
        meta._tunnel_metadata_mpls_label123 = hdr.mpls[2].label;
        meta._tunnel_metadata_mpls_exp124 = hdr.mpls[2].exp;
    }
    ...
    @name(".set_storm_control_meter") action _set_storm_control_meter_0(bit<32> meter_idx) {
        _storm_control_meter.execute_meter<bit<1>>(meter_idx, meta._security_metadata_storm_control_color117);
    }
    @name(".storm_control") table _storm_control {
        ...
        key = {
            ...
            meta._l2_metadata_lkp_pkt_type62: ternary @name("l2_metadata.lkp_pkt_type") ;
        }
        size = 512;
    ...
    @name(".set_bd") action _set_bd_0(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<1> ipv4_unicast_enabled, bit<1> ipv6_unicast_enabled, bit<2> ipv4_urpf_mode, bit<2> ipv6_urpf_mode, bit<1> igmp_snooping_enabled, bit<1> mld_snooping_enabled, bit<16> bd_label, bit<10> stp_group, bit<16> stats_idx, bit<1> learning_enabled) {
        meta._l3_metadata_vrf86 = vrf;
        meta._ipv4_metadata_ipv4_unicast_enabled55 = ipv4_unicast_enabled;
        meta._ipv6_metadata_ipv6_unicast_enabled59 = ipv6_unicast_enabled;
        meta._ipv4_metadata_ipv4_urpf_mode56 = ipv4_urpf_mode;
        meta._ipv6_metadata_ipv6_urpf_mode61 = ipv6_urpf_mode;
        meta._l3_metadata_rmac_group87 = rmac_group;
        meta._acl_metadata_bd_label9 = bd_label;
        meta._ingress_metadata_bd40 = bd;
        meta._ingress_metadata_outer_bd39 = bd;
        meta._l2_metadata_stp_group71 = stp_group;
        meta._l2_metadata_bd_stats_idx73 = stats_idx;
        meta._l2_metadata_learning_enabled74 = learning_enabled;
        meta._multicast_metadata_igmp_snooping_enabled103 = igmp_snooping_enabled;
        meta._multicast_metadata_mld_snooping_enabled104 = mld_snooping_enabled;
    }
    @name(".port_vlan_mapping_miss") action _port_vlan_mapping_miss_0() {
        meta._l2_metadata_port_vlan_mapping_miss75 = 1w1;
    }
    ...
    @name(".set_stp_state") action _set_stp_state_0(bit<3> stp_state) {
        meta._l2_metadata_stp_state72 = stp_state;
    }
    @name(".spanning_tree") table _spanning_tree {
        ...
        key = {
            meta._ingress_metadata_ifindex36: exact @name("ingress_metadata.ifindex") ;
            meta._l2_metadata_stp_group71   : exact @name("l2_metadata.stp_group") ;
        }
        size = 1024;
    ...
    @name(".ipsg_miss") action _ipsg_miss_0() {
        meta._security_metadata_ipsg_check_fail119 = 1w1;
    }
    @name(".ipsg") table _ipsg {
        ...
        key = {
            ...
            meta._l2_metadata_lkp_mac_sa63   : exact @name("l2_metadata.lkp_mac_sa") ;
            meta._ipv4_metadata_lkp_ipv4_sa53: exact @name("ipv4_metadata.lkp_ipv4_sa") ;
        }
        size = 1024;
    ...
    @name(".ipsg_permit_special") table _ipsg_permit_special {
        ...
        key = {
            meta._l3_metadata_lkp_ip_proto79 : ternary @name("l3_metadata.lkp_ip_proto") ;
            meta._l3_metadata_lkp_l4_dport83 : ternary @name("l3_metadata.lkp_l4_dport") ;
            meta._ipv4_metadata_lkp_ipv4_da54: ternary @name("ipv4_metadata.lkp_ipv4_da") ;
        }
        size = 512;
    ...
    @name(".terminate_tunnel_inner_non_ip") action _terminate_tunnel_inner_non_ip_0(bit<16> bd, bit<16> bd_label, bit<16> stats_idx) {
        meta._tunnel_metadata_tunnel_terminate133 = 1w1;
        meta._ingress_metadata_bd40 = bd;
        meta._l3_metadata_lkp_ip_type77 = 2w0;
        meta._l2_metadata_lkp_mac_sa63 = hdr.inner_ethernet.srcAddr;
        meta._l2_metadata_lkp_mac_da64 = hdr.inner_ethernet.dstAddr;
        meta._l2_metadata_lkp_mac_type65 = hdr.inner_ethernet.etherType;
        meta._acl_metadata_bd_label9 = bd_label;
        meta._l2_metadata_bd_stats_idx73 = stats_idx;
    }
    @name(".terminate_tunnel_inner_ethernet_ipv4") action _terminate_tunnel_inner_ethernet_ipv4_0(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<16> bd_label, bit<1> ipv4_unicast_enabled, bit<2> ipv4_urpf_mode, bit<1> igmp_snooping_enabled, bit<16> stats_idx) {
        ...
        meta._ingress_metadata_bd40 = bd;
        meta._l3_metadata_vrf86 = vrf;
        meta._qos_metadata_outer_dscp109 = meta._l3_metadata_lkp_ip_tc80;
        meta._l2_metadata_lkp_mac_sa63 = hdr.inner_ethernet.srcAddr;
        meta._l2_metadata_lkp_mac_da64 = hdr.inner_ethernet.dstAddr;
        meta._l2_metadata_lkp_mac_type65 = hdr.inner_ethernet.etherType;
        meta._l3_metadata_lkp_ip_type77 = 2w1;
        meta._ipv4_metadata_lkp_ipv4_sa53 = hdr.inner_ipv4.srcAddr;
        meta._ipv4_metadata_lkp_ipv4_da54 = hdr.inner_ipv4.dstAddr;
        meta._l3_metadata_lkp_ip_version78 = hdr.inner_ipv4.version;
        meta._l3_metadata_lkp_ip_proto79 = hdr.inner_ipv4.protocol;
        meta._l3_metadata_lkp_ip_ttl81 = hdr.inner_ipv4.ttl;
        meta._l3_metadata_lkp_ip_tc80 = hdr.inner_ipv4.diffserv;
        meta._l3_metadata_lkp_l4_sport82 = meta._l3_metadata_lkp_inner_l4_sport84;
        meta._l3_metadata_lkp_l4_dport83 = meta._l3_metadata_lkp_inner_l4_dport85;
        meta._ipv4_metadata_ipv4_unicast_enabled55 = ipv4_unicast_enabled;
        meta._ipv4_metadata_ipv4_urpf_mode56 = ipv4_urpf_mode;
        meta._l3_metadata_rmac_group87 = rmac_group;
        meta._acl_metadata_bd_label9 = bd_label;
    ...
    @name(".terminate_tunnel_inner_ethernet_ipv6") action _terminate_tunnel_inner_ethernet_ipv6_0(bit<16> bd, bit<12> vrf, bit<10> rmac_group, bit<16> bd_label, bit<1> ipv6_unicast_enabled, bit<2> ipv6_urpf_mode, bit<1> mld_snooping_enabled, bit<16> stats_idx) {
        ...
        meta._l2_metadata_lkp_mac_type65 = hdr.inner_ethernet.etherType;
        meta._l3_metadata_lkp_ip_type77 = 2w2;
        meta._ipv6_metadata_lkp_ipv6_sa57 = hdr.inner_ipv6.srcAddr;
        meta._ipv6_metadata_lkp_ipv6_da58 = hdr.inner_ipv6.dstAddr;
        meta._l3_metadata_lkp_ip_version78 = hdr.inner_ipv6.version;
        meta._l3_metadata_lkp_ip_proto79 = hdr.inner_ipv6.nextHdr;
        meta._l3_metadata_lkp_ip_ttl81 = hdr.inner_ipv6.hopLimit;
        meta._l3_metadata_lkp_ip_tc80 = hdr.inner_ipv6.trafficClass;
        meta._l3_metadata_lkp_l4_sport82 = meta._l3_metadata_lkp_inner_l4_sport84;
        meta._l3_metadata_lkp_l4_dport83 = meta._l3_metadata_lkp_inner_l4_dport85;
        meta._ipv6_metadata_ipv6_unicast_enabled59 = ipv6_unicast_enabled;
        meta._ipv6_metadata_ipv6_urpf_mode61 = ipv6_urpf_mode;
    ...
    @name(".tunnel") table _tunnel {
        ...
        key = {
            meta._tunnel_metadata_tunnel_vni121         : exact @name("tunnel_metadata.tunnel_vni") ;
            meta._tunnel_metadata_ingress_tunnel_type120: exact @name("tunnel_metadata.ingress_tunnel_type") ;
            hdr.inner_ipv4.isValid()                    : exact @name("inner_ipv4.$valid$") ;
            hdr.inner_ipv6.isValid()                    : exact @name("inner_ipv6.$valid$") ;
        }
    ...
    @name(".ipv4_dest_vtep") table _ipv4_dest_vtep_0 {
        ...
        key = {
            meta._l3_metadata_vrf86                     : exact @name("l3_metadata.vrf") ;
            meta._ipv4_metadata_lkp_ipv4_da54           : exact @name("ipv4_metadata.lkp_ipv4_da") ;
            meta._tunnel_metadata_ingress_tunnel_type120: exact @name("tunnel_metadata.ingress_tunnel_type") ;
        }
        size = 1024;
    ...
    @name(".ipv6_dest_vtep") table _ipv6_dest_vtep_0 {
        ...
        key = {
            meta._l3_metadata_vrf86                     : exact @name("l3_metadata.vrf") ;
            meta._ipv6_metadata_lkp_ipv6_da58           : exact @name("ipv6_metadata.lkp_ipv6_da") ;
            meta._tunnel_metadata_ingress_tunnel_type120: exact @name("tunnel_metadata.ingress_tunnel_type") ;
        }
        size = 1024;
    ...
    @name(".ipv6_src_vtep") table _ipv6_src_vtep_0 {
        ...
        key = {
            meta._l3_metadata_vrf86          : exact @name("l3_metadata.vrf") ;
            meta._ipv6_metadata_lkp_ipv6_sa57: exact @name("ipv6_metadata.lkp_ipv6_sa") ;
        }
        size = 1024;
    ...
    @name(".terminate_eompls") action _terminate_eompls(bit<16> bd, bit<5> tunnel_type) {
        meta._tunnel_metadata_tunnel_terminate133 = 1w1;
        meta._tunnel_metadata_ingress_tunnel_type120 = tunnel_type;
        meta._ingress_metadata_bd40 = bd;
        meta._l2_metadata_lkp_mac_sa63 = hdr.inner_ethernet.srcAddr;
        meta._l2_metadata_lkp_mac_da64 = hdr.inner_ethernet.dstAddr;
        meta._l2_metadata_lkp_mac_type65 = hdr.inner_ethernet.etherType;
    ...
    @name(".forward_mpls") action _forward_mpls(bit<16> nexthop_index) {
        meta._l3_metadata_fib_nexthop94 = nexthop_index;
        meta._l3_metadata_fib_nexthop_type95 = 1w0;
        meta._l3_metadata_fib_hit93 = 1w1;
    }
    @name(".mpls") table _mpls_0 {
        ...
        key = {
            meta._tunnel_metadata_mpls_label123: exact @name("tunnel_metadata.mpls_label") ;
            hdr.inner_ipv4.isValid()           : exact @name("inner_ipv4.$valid$") ;
            hdr.inner_ipv6.isValid()           : exact @name("inner_ipv6.$valid$") ;
        }
        size = 1024;
    ...
    @name(".set_unicast_and_ipv6_src_is_link_local") action _set_unicast_and_ipv6_src_is_link_local_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w1;
        meta._ipv6_metadata_ipv6_src_is_link_local60 = 1w1;
    }
    @name(".set_multicast") action _set_multicast_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w2;
        meta._l2_metadata_bd_stats_idx73 = meta._l2_metadata_bd_stats_idx73 + 16w1;
    }
    ...
    @name(".set_broadcast") action _set_broadcast_0() {
        meta._l2_metadata_lkp_pkt_type62 = 3w4;
        meta._l2_metadata_bd_stats_idx73 = meta._l2_metadata_bd_stats_idx73 + 16w2;
    }
    ...
    @name(".validate_packet") table _validate_packet {
        ...
        key = {
            meta._l2_metadata_lkp_mac_sa63[40:40]     : ternary @name("l2_metadata.lkp_mac_sa") ;
            meta._l2_metadata_lkp_mac_da64            : ternary @name("l2_metadata.lkp_mac_da") ;
            meta._l3_metadata_lkp_ip_type77           : ternary @name("l3_metadata.lkp_ip_type") ;
            meta._l3_metadata_lkp_ip_ttl81            : ternary @name("l3_metadata.lkp_ip_ttl") ;
            meta._l3_metadata_lkp_ip_version78        : ternary @name("l3_metadata.lkp_ip_version") ;
            meta._ipv4_metadata_lkp_ipv4_sa53[31:24]  : ternary @name("ipv4_metadata.lkp_ipv4_sa") ;
            meta._ipv6_metadata_lkp_ipv6_sa57[127:112]: ternary @name("ipv6_metadata.lkp_ipv6_sa") ;
        }
        size = 512;
    ...
    @name(".dmac_hit") action _dmac_hit_0(bit<16> ifindex) {
        meta._ingress_metadata_egress_ifindex37 = ifindex;
        meta._l2_metadata_same_if_check76 = meta._l2_metadata_same_if_check76 ^ ifindex;
    }
    ...
    @name(".dmac_redirect_nexthop") action _dmac_redirect_nexthop_0(bit<16> nexthop_index) {
        meta._l2_metadata_l2_redirect68 = 1w1;
        meta._l2_metadata_l2_nexthop66 = nexthop_index;
        meta._l2_metadata_l2_nexthop_type67 = 1w0;
    }
    @name(".dmac_redirect_ecmp") action _dmac_redirect_ecmp_0(bit<16> ecmp_index) {
        meta._l2_metadata_l2_redirect68 = 1w1;
        meta._l2_metadata_l2_nexthop66 = ecmp_index;
        meta._l2_metadata_l2_nexthop_type67 = 1w1;
    }
    @name(".dmac_drop") action _dmac_drop_0() {
        mark_to_drop(standard_metadata);
    }
    @name(".smac_miss") action _smac_miss_0() {
        meta._l2_metadata_l2_src_miss69 = 1w1;
    }
    @name(".smac_hit") action _smac_hit_0(bit<16> ifindex) {
        meta._l2_metadata_l2_src_move70 = meta._ingress_metadata_ifindex36 ^ ifindex;
    }
    ...
    @name(".mac_acl") table _mac_acl {
        ...
        key = {
            ...
            meta._l2_metadata_lkp_mac_sa63  : ternary @name("l2_metadata.lkp_mac_sa") ;
            meta._l2_metadata_lkp_mac_da64  : ternary @name("l2_metadata.lkp_mac_da") ;
            meta._l2_metadata_lkp_mac_type65: ternary @name("l2_metadata.lkp_mac_type") ;
        }
        size = 512;
    ...
    @name(".ip_acl") table _ip_acl {
        ...
        key = {
            meta._acl_metadata_if_label8     : ternary @name("acl_metadata.if_label") ;
            meta._acl_metadata_bd_label9     : ternary @name("acl_metadata.bd_label") ;
            meta._ipv4_metadata_lkp_ipv4_sa53: ternary @name("ipv4_metadata.lkp_ipv4_sa") ;
            meta._ipv4_metadata_lkp_ipv4_da54: ternary @name("ipv4_metadata.lkp_ipv4_da") ;
            meta._l3_metadata_lkp_ip_proto79 : ternary @name("l3_metadata.lkp_ip_proto") ;
            meta._l3_metadata_lkp_l4_sport82 : ternary @name("l3_metadata.lkp_l4_sport") ;
            meta._l3_metadata_lkp_l4_dport83 : ternary @name("l3_metadata.lkp_l4_dport") ;
    ...
    @name(".ipv6_acl") table _ipv6_acl {
        ...
        key = {
            meta._acl_metadata_if_label8     : ternary @name("acl_metadata.if_label") ;
            meta._acl_metadata_bd_label9     : ternary @name("acl_metadata.bd_label") ;
            meta._ipv6_metadata_lkp_ipv6_sa57: ternary @name("ipv6_metadata.lkp_ipv6_sa") ;
            meta._ipv6_metadata_lkp_ipv6_da58: ternary @name("ipv6_metadata.lkp_ipv6_da") ;
            meta._l3_metadata_lkp_ip_proto79 : ternary @name("l3_metadata.lkp_ip_proto") ;
            meta._l3_metadata_lkp_l4_sport82 : ternary @name("l3_metadata.lkp_l4_sport") ;
            meta._l3_metadata_lkp_l4_dport83 : ternary @name("l3_metadata.lkp_l4_dport") ;
            hdr.tcp.flags                    : ternary @name("tcp.flags") ;
    ...
    @name(".qos") table _qos {
        ...
        key = {
            ...
            meta._ipv4_metadata_lkp_ipv4_da54: ternary @name("ipv4_metadata.lkp_ipv4_da") ;
            meta._l3_metadata_lkp_ip_proto79 : ternary @name("l3_metadata.lkp_ip_proto") ;
            meta._l3_metadata_lkp_ip_tc80    : ternary @name("l3_metadata.lkp_ip_tc") ;
            meta._tunnel_metadata_mpls_exp124: ternary @name("tunnel_metadata.mpls_exp") ;
            meta._qos_metadata_outer_dscp109 : ternary @name("qos_metadata.outer_dscp") ;
        }
        size = 512;
    ...
    @name(".ipv4_urpf_hit") action _ipv4_urpf_hit_0(bit<16> urpf_bd_group) {
        meta._l3_metadata_urpf_hit90 = 1w1;
        meta._l3_metadata_urpf_bd_group92 = urpf_bd_group;
        meta._l3_metadata_urpf_mode89 = meta._ipv4_metadata_ipv4_urpf_mode56;
    }
    ...
    @name(".urpf_miss") action _urpf_miss_1() {
        meta._l3_metadata_urpf_check_fail91 = 1w1;
    }
    ...
    @name(".ipv4_urpf_lpm") table _ipv4_urpf_lpm {
        ...
        key = {
            meta._l3_metadata_vrf86          : exact @name("l3_metadata.vrf") ;
            meta._ipv4_metadata_lkp_ipv4_sa53: lpm @name("ipv4_metadata.lkp_ipv4_sa") ;
        }
        size = 512;
    ...
    @name(".fib_hit_ecmp") action _fib_hit_ecmp_1(bit<16> ecmp_index) {
        meta._l3_metadata_fib_hit93 = 1w1;
        meta._l3_metadata_fib_nexthop94 = ecmp_index;
        meta._l3_metadata_fib_nexthop_type95 = 1w1;
    }
    ...
    @name(".ipv4_fib_lpm") table _ipv4_fib_lpm {
        ...
        key = {
            meta._l3_metadata_vrf86          : exact @name("l3_metadata.vrf") ;
            meta._ipv4_metadata_lkp_ipv4_da54: lpm @name("ipv4_metadata.lkp_ipv4_da") ;
        }
        size = 512;
    ...
    @name(".ipv6_urpf_hit") action _ipv6_urpf_hit_0(bit<16> urpf_bd_group) {
        meta._l3_metadata_urpf_hit90 = 1w1;
        meta._l3_metadata_urpf_bd_group92 = urpf_bd_group;
        meta._l3_metadata_urpf_mode89 = meta._ipv6_metadata_ipv6_urpf_mode61;
    }
    ...
    @name(".ipv6_urpf_lpm") table _ipv6_urpf_lpm {
        ...
        key = {
            meta._l3_metadata_vrf86          : exact @name("l3_metadata.vrf") ;
            meta._ipv6_metadata_lkp_ipv6_sa57: lpm @name("ipv6_metadata.lkp_ipv6_sa") ;
        }
        size = 512;
    ...
    @name(".ipv6_fib_lpm") table _ipv6_fib_lpm {
        ...
        key = {
            meta._l3_metadata_vrf86          : exact @name("l3_metadata.vrf") ;
            meta._ipv6_metadata_lkp_ipv6_da58: lpm @name("ipv6_metadata.lkp_ipv6_da") ;
        }
        size = 512;
    ...
    @name(".urpf_bd") table _urpf_bd {
        ...
        key = {
            meta._l3_metadata_urpf_bd_group92: exact @name("l3_metadata.urpf_bd_group") ;
            meta._ingress_metadata_bd40      : exact @name("ingress_metadata.bd") ;
        }
        size = 1024;
    ...
    @name(".terminate_fabric_unicast_packet") action _terminate_fabric_unicast_packet_0() {
        standard_metadata.egress_spec = (bit<9>)hdr.fabric_header.dstPortOrGroup;
        meta._tunnel_metadata_tunnel_terminate133 = hdr.fabric_header_unicast.tunnelTerminate;
        meta._tunnel_metadata_ingress_tunnel_type120 = hdr.fabric_header_unicast.ingressTunnelType;
        meta._l3_metadata_nexthop_index97 = hdr.fabric_header_unicast.nexthopIndex;
        meta._l3_metadata_routed98 = hdr.fabric_header_unicast.routed;
        meta._l3_metadata_outer_routed99 = hdr.fabric_header_unicast.outerRouted;
        hdr.ethernet.etherType = hdr.fabric_payload_header.etherType;
        hdr.fabric_header.setInvalid();
    ...
    @name(".terminate_fabric_multicast_packet") action _terminate_fabric_multicast_packet_0() {
        meta._tunnel_metadata_tunnel_terminate133 = hdr.fabric_header_multicast.tunnelTerminate;
        meta._tunnel_metadata_ingress_tunnel_type120 = hdr.fabric_header_multicast.ingressTunnelType;
        meta._l3_metadata_nexthop_index97 = 16w0;
        meta._l3_metadata_routed98 = hdr.fabric_header_multicast.routed;
        meta._l3_metadata_outer_routed99 = hdr.fabric_header_multicast.outerRouted;
    ...
    @name(".compute_lkp_ipv4_hash") action _compute_lkp_ipv4_hash_0() {
        hash<bit<16>, bit<16>, tuple_2, bit<32>>(meta._hash_metadata_hash130, HashAlgorithm.crc16, 16w0, { meta._ipv4_metadata_lkp_ipv4_sa53, meta._ipv4_metadata_lkp_ipv4_da54, meta._l3_metadata_lkp_ip_proto79, meta._l3_metadata_lkp_l4_sport82, meta._l3_metadata_lkp_l4_dport83 }, 32w65536);
        hash<bit<16>, bit<16>, tuple_3, bit<32>>(meta._hash_metadata_hash231, HashAlgorithm.crc16, 16w0, { meta._l2_metadata_lkp_mac_sa63, meta._l2_metadata_lkp_mac_da64, meta._ipv4_metadata_lkp_ipv4_sa53, meta._ipv4_metadata_lkp_ipv4_da54, meta._l3_metadata_lkp_ip_proto79, meta._l3_metadata_lkp_l4_sport82, meta._l3_metadata_lkp_l4_dport83 }, 32w65536);
    }
    @name(".compute_lkp_ipv6_hash") action _compute_lkp_ipv6_hash_0() {
        hash<bit<16>, bit<16>, tuple_4, bit<32>>(meta._hash_metadata_hash130, HashAlgorithm.crc16, 16w0, { meta._ipv6_metadata_lkp_ipv6_sa57, meta._ipv6_metadata_lkp_ipv6_da58, meta._l3_metadata_lkp_ip_proto79, meta._l3_metadata_lkp_l4_sport82, meta._l3_metadata_lkp_l4_dport83 }, 32w65536);
        hash<bit<16>, bit<16>, tuple_5, bit<32>>(meta._hash_metadata_hash231, HashAlgorithm.crc16, 16w0, { meta._l2_metadata_lkp_mac_sa63, meta._l2_metadata_lkp_mac_da64, meta._ipv6_metadata_lkp_ipv6_sa57, meta._ipv6_metadata_lkp_ipv6_da58, meta._l3_metadata_lkp_ip_proto79, meta._l3_metadata_lkp_l4_sport82, meta._l3_metadata_lkp_l4_dport83 }, 32w65536);
    }
    @name(".compute_lkp_non_ip_hash") action _compute_lkp_non_ip_hash_0() {
        hash<bit<16>, bit<16>, tuple_6, bit<32>>(meta._hash_metadata_hash231, HashAlgorithm.crc16, 16w0, { meta._ingress_metadata_ifindex36, meta._l2_metadata_lkp_mac_sa63, meta._l2_metadata_lkp_mac_da64, meta._l2_metadata_lkp_mac_type65 }, 32w65536);
    }
    ...
    @name(".update_ingress_bd_stats") action _update_ingress_bd_stats_0() {
        _ingress_bd_stats_count.count((bit<32>)meta._l2_metadata_bd_stats_idx73);
    }
    ...
    @name(".set_l2_redirect_action") action _set_l2_redirect_action_0() {
        meta._l3_metadata_nexthop_index97 = meta._l2_metadata_l2_nexthop66;
        meta._nexthop_metadata_nexthop_type108 = meta._l2_metadata_l2_nexthop_type67;
    }
    @name(".set_fib_redirect_action") action _set_fib_redirect_action_0() {
        meta._l3_metadata_nexthop_index97 = meta._l3_metadata_fib_nexthop94;
        meta._nexthop_metadata_nexthop_type108 = meta._l3_metadata_fib_nexthop_type95;
        meta._l3_metadata_routed98 = 1w1;
    ...
    @name(".set_cpu_redirect_action") action _set_cpu_redirect_action_0() {
        meta._l3_metadata_routed98 = 1w0;
        standard_metadata.mcast_grp = 16w0;
    ...
    @name(".set_acl_redirect_action") action _set_acl_redirect_action_0() {
        meta._l3_metadata_nexthop_index97 = meta._acl_metadata_acl_nexthop2;
        meta._nexthop_metadata_nexthop_type108 = meta._acl_metadata_acl_nexthop_type4;
    }
    @name(".set_racl_redirect_action") action _set_racl_redirect_action_0() {
        meta._l3_metadata_nexthop_index97 = meta._acl_metadata_racl_nexthop3;
        meta._nexthop_metadata_nexthop_type108 = meta._acl_metadata_racl_nexthop_type5;
        meta._l3_metadata_routed98 = 1w1;
    }
    @name(".fwd_result") table _fwd_result {
        ...
        key = {
            meta._l2_metadata_l2_redirect68  : ternary @name("l2_metadata.l2_redirect") ;
            ...
            meta._l3_metadata_rmac_hit88     : ternary @name("l3_metadata.rmac_hit") ;
            meta._l3_metadata_fib_hit93      : ternary @name("l3_metadata.fib_hit") ;
        }
        size = 512;
    ...
    @name(".set_ecmp_nexthop_details") action _set_ecmp_nexthop_details_0(bit<16> ifindex, bit<16> bd, bit<16> nhop_index, bit<1> tunnel) {
        meta._ingress_metadata_egress_ifindex37 = ifindex;
        meta._l3_metadata_nexthop_index97 = nhop_index;
        meta._l3_metadata_same_bd_check96 = meta._ingress_metadata_bd40 ^ bd;
        meta._l2_metadata_same_if_check76 = meta._l2_metadata_same_if_check76 ^ ifindex;
        meta._tunnel_metadata_tunnel_if_check134 = meta._tunnel_metadata_tunnel_terminate133 ^ tunnel;
    }
    ...
    @name(".bd_flood") table _bd_flood {
        ...
        key = {
            meta._ingress_metadata_bd40     : exact @name("ingress_metadata.bd") ;
            meta._l2_metadata_lkp_pkt_type62: exact @name("l2_metadata.lkp_pkt_type") ;
        }
        size = 1024;
    ...
    @name(".generate_learn_notify") action _generate_learn_notify_0() {
        digest<mac_learn_digest>(32w1024, {meta._ingress_metadata_bd40,meta._l2_metadata_lkp_mac_sa63,meta._ingress_metadata_ifindex36});
    }
    @name(".learn_notify") table _learn_notify {
        ...
        key = {
            meta._l2_metadata_l2_src_miss69: ternary @name("l2_metadata.l2_src_miss") ;
            meta._l2_metadata_l2_src_move70: ternary @name("l2_metadata.l2_src_move") ;
            meta._l2_metadata_stp_state72  : ternary @name("l2_metadata.stp_state") ;
        }
        size = 512;
    ...
    @name(".set_fabric_multicast") action _set_fabric_multicast_0(bit<8> fabric_mgid) {
        meta._multicast_metadata_mcast_grp107 = standard_metadata.mcast_grp;
    }
    ...
    @name(".system_acl") table _system_acl {
        ...
        key = {
            ...
            meta._l2_metadata_port_vlan_mapping_miss75  : ternary @name("l2_metadata.port_vlan_mapping_miss") ;
            meta._security_metadata_ipsg_check_fail119  : ternary @name("security_metadata.ipsg_check_fail") ;
            ...
            meta._l3_metadata_urpf_check_fail91         : ternary @name("l3_metadata.urpf_check_fail") ;
            meta._ingress_metadata_drop_flag41          : ternary @name("ingress_metadata.drop_flag") ;
            meta._l3_metadata_rmac_hit88                : ternary @name("l3_metadata.rmac_hit") ;
            meta._l3_metadata_routed98                  : ternary @name("l3_metadata.routed") ;
            meta._ipv6_metadata_ipv6_src_is_link_local60: ternary @name("ipv6_metadata.ipv6_src_is_link_local") ;
            meta._l2_metadata_same_if_check76           : ternary @name("l2_metadata.same_if_check") ;
            meta._tunnel_metadata_tunnel_if_check134    : ternary @name("tunnel_metadata.tunnel_if_check") ;
            meta._l3_metadata_same_bd_check96           : ternary @name("l3_metadata.same_bd_check") ;
            meta._l3_metadata_lkp_ip_ttl81              : ternary @name("l3_metadata.lkp_ip_ttl") ;
            meta._l2_metadata_stp_state72               : ternary @name("l2_metadata.stp_state") ;
            meta._ingress_metadata_control_frame43      : ternary @name("ingress_metadata.control_frame") ;
            meta._ipv4_metadata_ipv4_unicast_enabled55  : ternary @name("ipv4_metadata.ipv4_unicast_enabled") ;
    ...
    apply {
        ...
        if (meta._ingress_metadata_port_type38 == 2w0) {
            ...
            if (meta._l2_metadata_stp_group71 != 10w0) 
                _spanning_tree.apply();
            if (meta._security_metadata_ipsg_enabled118 == 1w1) 
            ...
            if (meta._tunnel_metadata_tunnel_terminate133 == 1w1) 
                _tunnel.apply();
            if (!hdr.mpls[0].isValid() || hdr.mpls[0].isValid() && meta._tunnel_metadata_tunnel_terminate133 == 1w1) {
                if (meta._ingress_metadata_drop_flag41 == 1w0) 
                    _validate_packet.apply();
                _smac.apply();
                _dmac.apply();
                if (meta._l3_metadata_lkp_ip_type77 == 2w0) 
                    _mac_acl.apply();
                else 
                    if (meta._l3_metadata_lkp_ip_type77 == 2w1) 
                        _ip_acl.apply();
                    else 
                        if (meta._l3_metadata_lkp_ip_type77 == 2w2) 
                            _ipv6_acl.apply();
                _qos.apply();
                switch (rmac_0.apply().action_run) {
                    rmac_hit_1: {
                        if (meta._l3_metadata_lkp_ip_type77 == 2w1 && meta._ipv4_metadata_ipv4_unicast_enabled55 == 1w1) {
                            _ipv4_racl.apply();
                            if (meta._ipv4_metadata_ipv4_urpf_mode56 != 2w0) 
                            ...
                            if (meta._l3_metadata_lkp_ip_type77 == 2w2 && meta._ipv6_metadata_ipv6_unicast_enabled59 == 1w1) {
                                _ipv6_racl.apply();
                                if (meta._ipv6_metadata_ipv6_urpf_mode61 != 2w0) 
                        ...
                        if (meta._l3_metadata_urpf_mode89 == 2w2 && meta._l3_metadata_urpf_hit90 == 1w1) 
                            _urpf_bd.apply();
                    }
                }
        ...
        if (meta._tunnel_metadata_tunnel_terminate133 == 1w0 && hdr.ipv4.isValid() || meta._tunnel_metadata_tunnel_terminate133 == 1w1 && hdr.inner_ipv4.isValid()) 
            _compute_ipv4_hashes.apply();
        else 
            if (meta._tunnel_metadata_tunnel_terminate133 == 1w0 && hdr.ipv6.isValid() || meta._tunnel_metadata_tunnel_terminate133 == 1w1 && hdr.inner_ipv6.isValid()) 
        ...
        if (meta._ingress_metadata_port_type38 == 2w0) {
            ...
            _acl_stats.apply();
            _fwd_result.apply();
            if (meta._nexthop_metadata_nexthop_type108 == 1w1) 
                _ecmp_group.apply();
            else 
                _nexthop.apply();
            if (meta._ingress_metadata_egress_ifindex37 == 16w65535) 
                ...
                _lag_group.apply();
            if (meta._l2_metadata_learning_enabled74 == 1w1) 
                _learn_notify.apply();
        }
        _fabric_lag.apply();
        _system_acl.apply();
