...
control process_outer_multicast(inout __headersImpl hdr, inout __metadataImpl meta, inout standard_metadata_t __standard_metadata) {
    ...
    apply {
        if (hdr.ipv4.isValid()) 
            process_outer_ipv4_multicast_1.apply(hdr, meta, __standard_metadata);
        else 
            if (hdr.ipv6.isValid()) 
                process_outer_ipv6_multicast_1.apply(hdr, meta, __standard_metadata);
        process_outer_multicast_rpf_1.apply(hdr, meta, __standard_metadata);
    }
}
    ...
    apply {
        ...
        if (meta.tunnel_metadata.ingress_tunnel_type != 5w0) 
            switch (outer_rmac_0.apply().action_run) {
                ...
                on_miss_7: {
                    process_outer_multicast_1.apply(hdr, meta, __standard_metadata);
                }
            }
...
control process_multicast(inout __headersImpl hdr, inout __metadataImpl meta, inout standard_metadata_t __standard_metadata) {
    ...
    apply {
        if (meta.l3_metadata.lkp_ip_type == 2w1) 
            process_ipv4_multicast_1.apply(hdr, meta, __standard_metadata);
        else 
            if (meta.l3_metadata.lkp_ip_type == 2w2) 
                process_ipv6_multicast_1.apply(hdr, meta, __standard_metadata);
        process_multicast_rpf_1.apply(hdr, meta, __standard_metadata);
    }
}
...
control ingress(inout __headersImpl hdr, inout __metadataImpl meta, inout standard_metadata_t __standard_metadata) {
    ...
    apply {
        ...
        process_global_params_1.apply(hdr, meta, __standard_metadata);
        ...
        process_ingress_sflow_1.apply(hdr, meta, __standard_metadata);
        ...
        if (meta.ingress_metadata.port_type != 2w1) 
            if (!(hdr.mpls[0].isValid() && meta.l3_metadata.fib_hit == 1w1)) {
                ...
                switch (rmac_0.apply().action_run) {
                    ...
                    rmac_miss_0: {
                        process_multicast_1.apply(hdr, meta, __standard_metadata);
                    }
                }

            }
        process_meter_index_1.apply(hdr, meta, __standard_metadata);
        process_hashes_1.apply(hdr, meta, __standard_metadata);
        process_meter_action_1.apply(hdr, meta, __standard_metadata);
        if (meta.ingress_metadata.port_type != 2w1) {
            ...
            process_storm_control_stats_1.apply(hdr, meta, __standard_metadata);
