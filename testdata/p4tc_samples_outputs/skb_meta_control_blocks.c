                    ...
                    if (value != NULL) {
                        ...
                        switch (value->action) {
                            case INGRESS_NH_TABLE_ACT_INGRESS_SEND_NH: 
                                {
/* sm.get() */
/* SKB metadata: call get */bpf_p4tc_skb_meta_get(skb,&sa->get,sizeof(sa->get));
                                                                        mark_0 = /* sm.get_mark() */
/* SKB metadata: call get_mark */bpf_p4tc_skb_get_mark(skb,&sa->get);
                                    /* sm.set_mark((mark_0 + 1)) */
/* SKB metadata: call set_mark */bpf_p4tc_skb_set_mark(skb,&sa->set,(mark_0 + 1));
                                                                        tmp = /* sm.get_tc_classid() */
/* SKB metadata: call get_tc_classid */bpf_p4tc_skb_get_tc_classid(skb,&sa->get);
                                    /* sm.set_tc_classid((tmp + 1)) */
/* SKB metadata: call set_tc_classid */bpf_p4tc_skb_set_tc_classid(skb,&sa->set,(tmp + 1));
                                                                        tmp_2 = /* sm.get_tc_index() */
/* SKB metadata: call get_tc_index */bpf_p4tc_skb_get_tc_index(skb,&sa->get);
                                    /* sm.set_tc_index((tmp_2 + 1)) */
/* SKB metadata: call set_tc_index */bpf_p4tc_skb_set_tc_index(skb,&sa->set,(tmp_2 + 1));
...
/* SKB metadata: call get_mark */bpf_p4tc_skb_get_mark(skb,&sa->get);
                /* sm.get_tstamp() */
/* SKB metadata: call get_tstamp */bpf_p4tc_skb_get_tstamp(skb,&sa->get);
                /* sm.get_tc_classid() */
/* SKB metadata: call get_tc_classid */bpf_p4tc_skb_get_tc_classid(skb,&sa->get);
                /* sm.get_tc_index() */
/* SKB metadata: call get_tc_index */bpf_p4tc_skb_get_tc_index(skb,&sa->get);
                /* sm.get_queue_mapping() */
/* SKB metadata: call get_queue_mapping */bpf_p4tc_skb_get_queue_mapping(skb,&sa->get);
                /* sm.set() */
/* SKB metadata: call set */bpf_p4tc_skb_meta_set(skb,&sa->set,sizeof(sa->set));
            }
        }
    }
    {
...
int tc_ingress_func(struct __sk_buff *skb) {
    struct skb_aggregate skbstuff = {
        ...
        .get = { .bitmask = P4TC_SKB_META_GET_AT_INGRESS_BIT | P4TC_SKB_META_GET_FROM_INGRESS_BIT },
        .set = { },
};
