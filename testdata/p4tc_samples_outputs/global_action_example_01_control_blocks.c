...
/* send_to_port(value->u._send_nh.port_id) */
                                ...
                                send_to_port(value->u._send_nh.port_id);
                                storePrimitive64((u8 *)&hdr->ethernet.srcAddr[0], 48, getPrimitive64((u8 *)(value->u._send_nh.smac), 48));
                                storePrimitive64((u8 *)&hdr->ethernet.dstAddr[0], 48, getPrimitive64((u8 *)(value->u._send_nh.dmac), 48));
                            }
                            break;
