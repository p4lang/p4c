...
;
                /* ipv4_tbl_5.apply() */
                {
                    ...
                    if (value != NULL) {
                        /* run action */
                        switch (value->action) {
                            case MAINCONTROLIMPL_IPV4_TBL_3_ACT_MAINCONTROLIMPL_NEXT_HOP: 
                                {
/* send_to_port(value->u.MainControlImpl_next_hop.vport) */
                                    compiler_meta__->drop = false;
                                    send_to_port(value->u.MainControlImpl_next_hop.vport);
...
/* drop_packet() */
                                ...
                                break;
                            case MAINCONTROLIMPL_IPV4_TBL_3_ACT_NOACTION: 
                                {
                                }
                                break;
                        }
...
;
                /* ipv4_tbl_6.apply() */
                {
                    ...
                    if (value != NULL) {
                        /* run action */
                        switch (value->action) {
                            case MAINCONTROLIMPL_IPV4_TBL_4_ACT_MAINCONTROLIMPL_NEXT_HOP: 
                                {
/* send_to_port(value->u.MainControlImpl_next_hop.vport) */
                                    compiler_meta__->drop = false;
                                    send_to_port(value->u.MainControlImpl_next_hop.vport);
...
/* drop_packet() */
                                ...
                                break;
                            case MAINCONTROLIMPL_IPV4_TBL_4_ACT_NOACTION: 
                                {
                                }
                                break;
                        }
