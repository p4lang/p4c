    ...
    inout standard_metadata_t stdmeta)
{
    ...
    table t1 {
        ...
        actions = { a; a_params; }
        default_action = a;
        // This table definition should give an error, because there
        // is at least one entry with an explicit priority given for
        // it, but the first entry does not have an explicit priority
        // given for it.
        entries = {
