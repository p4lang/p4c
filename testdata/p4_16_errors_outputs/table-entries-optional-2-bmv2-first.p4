...
control ingress(inout Header_t h, inout Meta_t m, inout standard_metadata_t standard_meta) {
    ...
    table t_optional {
        ...
        default_action = a();
        const entries = {
                        (8w0xaa &&& 8w0x7f, 16w0x1111 &&& 16w0xffff) : a_with_control_params(9w1);

                        (default, 16w0x1111 &&& 16w0x8000) : a_with_control_params(9w2);

                        (8w0xaa &&& 8w0x8, default) : a_with_control_params(9w3);

                        (8w0xaa &&& 8w0xf7, default) : a_with_control_params(9w4);

                        (default, 16w0x1111 &&& 16w0x0) : a_with_control_params(9w5);
