...
/// This pass makes sure that when several match tables share a selector, they 
/// use the same input for the selection algorithm.
/// This is because bmv2 considers that the selection
/// key is part of the action_selector while v1model.p4 
/// considers that it belongs to the table match key definition.
