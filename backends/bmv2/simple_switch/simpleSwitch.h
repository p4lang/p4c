...
EXTERN_CONVERTER_W_FUNCTION_AND_MODEL(clone3_field_list, P4V1::V1Model, v1model)
EXTERN_CONVERTER_W_FUNCTION_AND_MODEL(hash, P4V1::V1Model, v1model)
EXTERN_CONVERTER_W_FUNCTION(digest)
EXTERN_CONVERTER_W_FUNCTION(resubmit_field_list)
EXTERN_CONVERTER_W_FUNCTION(recirculate_field_list)
