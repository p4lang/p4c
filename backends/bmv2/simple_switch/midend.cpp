...
SimpleSwitchMidEnd::SimpleSwitchMidEnd(CompilerOptions &options, std::ostream *outStream)
    ...
    if (!BMV2::SimpleSwitchContext::get().options().loadIRFromJson) {
        ...
        addPasses({options.ndebug ? new P4::RemoveAssertAssume(&typeMap) : nullptr,
                   ...
                   new P4::TypeChecking(&refMap, &typeMap),
                   new P4::SimplifyKey(
                       &typeMap, new P4::OrPolicy(new P4::IsValid(&typeMap), new P4::IsMask())),
                   ...
                   new P4::TypeChecking(&refMap, &typeMap),
                   {options.loopsUnrolling ? new P4::ParsersUnroll(true, false, &refMap, &typeMap)
                                           : nullptr},
                   evaluator,
