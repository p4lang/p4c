...
std::ostream& operator<<(std::ostream& out, const IR::DpdkStructType* h);
std::ostream& operator<<(std::ostream& out, const IR::DpdkAsmStatement* s);
std::ostream& operator<<(std::ostream& out, const IR::DpdkListStatement* statement);
std::ostream& operator<<(std::ostream& out, const IR::DpdkMovStatement* statement);
