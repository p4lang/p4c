...
/// Retrieve packets from a pcap file.
/// Retrieves a list of packets from a given pcap file.
...
/// Merges a given list array into a single list.
/// Expects a handle to an array list and allocates a single list from
...
/// Splits a list of packets by interface.
/// Splits the given list by the interface indicator in the
...
/// Appends a  packet to a given list of packets.
/// This function takes a pointer to a packet and appends it to the
...
/// Inserts a packet list in the array at a given index.
/// This function takes a pointer to a packet list and inserts it at
...
/// Get a packet from a given index.
///
...
/// Copies a packet in full, including its referenced data.
/// Allocates a new packet and copies all data and structures
...
/// Completely erases the list.
/// Deletes the given list. Also deletes the data referenced by the
/// pcap packets in the list.
///
/// @param pkt_list The list to delete.
void delete_list(pcap_list_t *pkt_list);

/// Completely erases a list array and the lists in the array.
/// Deletes the given array. Also deletes the list as well as the
...
/// Sorts a given list by the timestamp of the packets contained in it.
/// This alters the order in place, the input list is permanently modified.
///
/// @param pkt_list A list.
void sort_pcap_list(pcap_list_t *pkt_list);

/// Create a pcap file name from a given base name, interface index,
