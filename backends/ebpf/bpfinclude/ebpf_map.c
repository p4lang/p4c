...
enum bpf_flags {
    BPF_ANY,  // BPF_ANY create new element or update existing
    BPF_NOEXIST,  // BPF_NOEXIST: create new element only if it didn't exist
    BPF_EXIST  // BPF_EXIST: only update existing element
};
