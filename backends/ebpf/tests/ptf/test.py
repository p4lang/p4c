...
@unittest.skip("Disabled on Ubuntu 22.04 - Tracking in #5201 - https://github.com/p4lang/p4c/issues/5201")
...
@unittest.skip("Disabled on Ubuntu 22.04 - Tracking in #5201 - ")
class PSATernaryTest(P4EbpfTest):
    """Ternary match tests (currently disabled on Ubuntu 22.04)."""
