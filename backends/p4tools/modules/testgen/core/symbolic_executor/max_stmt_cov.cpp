...
void DetMaxStmtCoverage::run(const Callback &callback) {
...
DetMaxStmtCoverage::DetMaxStmtCoverage(AbstractSolver &solver, const ProgramInfo &programInfo)
    : SymbolicExecutor(solver, programInfo) {}

void DetMaxStmtCoverage::sortBranchesByCoverage(std::vector<Branch> &branches) {
...
ExecutionState *DetMaxStmtCoverage::chooseBranch(std::vector<Branch> &branches,
...
RandomMaxStmtCoverage::RandomMaxStmtCoverage(AbstractSolver &solver, const ProgramInfo &programInfo,
    ...
    : DetMaxStmtCoverage(solver, programInfo), saddlePoint(saddlePoint) {}
