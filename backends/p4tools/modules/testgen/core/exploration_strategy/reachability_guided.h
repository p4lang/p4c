#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_REACHABILITY_GUIDED_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_REACHABILITY_GUIDED_H_
...
class ReachabilityGuided : public IncrementalStack {
 public:
    ...
    ReachabilityGuided(AbstractSolver& solver, const ProgramInfo& programInfo,
...
#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_CORE_EXPLORATION_STRATEGY_REACHABILITY_GUIDED_H_ */
