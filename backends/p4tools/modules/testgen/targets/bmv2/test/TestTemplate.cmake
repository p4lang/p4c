...
function(validate_protobuf testfile testfolder)
  ...
  file(APPEND ${testfile} "do\n")
  file(APPEND ${testfile} "\techo \"Found \${item}\"\n")
  file(APPEND ${testfile} "\t${PROTOC_BINARY} --proto_path ${Protobuf_INCLUDE_DIR} --proto_path ${CMAKE_CURRENT_LIST_DIR}/../proto --proto_path ${P4RUNTIME_STD_DIR} --proto_path ${P4C_SOURCE_DIR}/control-plane --encode=p4testgen.TestCase p4testgen.proto < \${item} > /dev/null\n")
  file(APPEND ${testfile} "done\n")
...
function(validate_protobuf_ir testfile testfolder)
  ...
  file(APPEND ${testfile} "do\n")
  file(APPEND ${testfile} "\techo \"Found \${item}\"\n")
  file(APPEND ${testfile} "\t${PROTOC_BINARY} --proto_path ${Protobuf_INCLUDE_DIR} --proto_path ${CMAKE_CURRENT_LIST_DIR}/../proto --proto_path ${P4RUNTIME_STD_DIR} --proto_path ${P4C_SOURCE_DIR} --proto_path ${P4C_SOURCE_DIR}/control-plane --encode=p4testgen_ir.TestCase p4testgen_ir.proto < \${item} > /dev/null\n")
  file(APPEND ${testfile} "done\n")
