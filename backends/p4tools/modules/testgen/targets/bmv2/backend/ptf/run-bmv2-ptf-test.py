...
def run_test(options):
    ...
    p4c_bm2_ss = "p4c-bm2-ss --target bmv2 --arch v1model --p4runtime-files " + \
    ...
    print(f"RUNNING {simple_switch_grpc}")
    logP = subprocess.Popen(
        log, shell=True, stdin=subprocess.PIPE, universal_newlines=True)
