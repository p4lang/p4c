#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_CMD_STEPPER_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_CMD_STEPPER_H_
...
class PnaP4TCCmdStepper : public SharedPnaCmdStepper {
 protected:
    std::string getClassName() override;

    const PnaP4TCProgramInfo &getProgramInfo() const override;
 ...
 public:
    PnaP4TCCmdStepper(ExecutionState &state, AbstractSolver &solver,
                      const ProgramInfo &programInfo);
};

}  // namespace P4::P4Tools::P4Testgen::Pna

#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_CMD_STEPPER_H_ */
