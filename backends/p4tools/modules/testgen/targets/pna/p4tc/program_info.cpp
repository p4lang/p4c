...
const ArchSpec &PnaP4TCProgramInfo::getArchSpec() const { return ARCH_SPEC; }

std::vector<Continuation::Command> PnaP4TCProgramInfo::processDeclaration(
...
const ArchSpec PnaP4TCProgramInfo::ARCH_SPEC = ArchSpec(
    "PNA_NIC"_cs,
    {
