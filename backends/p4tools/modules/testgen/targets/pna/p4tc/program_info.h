#ifndef BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_PROGRAM_INFO_H_
#define BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_PROGRAM_INFO_H_
...
class PnaP4TCProgramInfo : public SharedPnaProgramInfo {
 private:
 ...
 public:
    PnaP4TCProgramInfo(const TestgenCompilerResult &compilerResult,
    ...
    DECLARE_TYPEINFO(PnaP4TCProgramInfo, SharedPnaProgramInfo);
};

}  // namespace P4::P4Tools::P4Testgen::Pna

#endif /* BACKENDS_P4TOOLS_MODULES_TESTGEN_TARGETS_PNA_P4TC_PROGRAM_INFO_H_ */
