...
control SwitchIngress(
    ...
    action a1() {
        h.h.a = hash1.get({8w0x45, 8w0x00, 8w0x00, 8w0x73, 8w0x00, 8w0x00,
                                        8w0x40, 8w0x00, 8w0x40, 8w0x11, 8w0x00, 8w0x00,
                                        8w0xc0, 8w0xa8, 8w0x00, 8w0x01, 8w0xc0, 8w0xa8,
                                        8w0x00, 8w0xc7});
        h.h.b = hash1.get({8w1, 8w0, 8w1, 8w0, 8w1, 8w0});
        h.h.c = hash1.get({8w0, 8w1, 8w0, 8w1, 8w0, 8w1});
        h.h.d = hash1.get({16w1, 16w1, 16w1});
        h.h.e = hash1.get({17w1, 15w1, 14w1});
