...
set(SMITH_BMV2_V1MODEL_ARGS 100 ${P4SMITH_DRIVER} ${CMAKE_BINARY_DIR}/p4c-bm2-ss ${CMAKE_BINARY_DIR} bmv2 v1model)

add_test (NAME smith-compile-bmv2-v1model COMMAND ${SMITH_BMV2_CMD} ${SMITH_BMV2_V1MODEL_ARGS} WORKING_DIRECTORY ${P4C_BINARY_DIR})

set(SMITH_BMV2_PSA_ARGS 100 ${P4SMITH_DRIVER} ${CMAKE_BINARY_DIR}/p4c-bm2-psa ${CMAKE_BINARY_DIR} bmv2 psa)
