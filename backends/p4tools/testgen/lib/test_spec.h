 ...
 *  ActionProfile
 * ========================================================================================= */
class ActionProfile : public TestObject {
 private:
 ...
 public:
    explicit ActionProfile(const IR::IDeclaration* profileDecl);
    ...
    const ActionProfile* evaluate(const Model& model) const override {
        auto profile = new ActionProfile(profileDecl);
 ...
 *  ActionSelector
 * ========================================================================================= */
class ActionSelector : public TestObject {
 private:
 ...
 public:
    explicit ActionSelector(const IR::IDeclaration* selectorDecl,
                            const ActionProfile* actionProfile);
    ...
    const ActionSelector* evaluate(const Model& model) const override {
        auto evaluatedProfile = actionProfile->evaluate(model);
        return new ActionSelector(selectorDecl, evaluatedProfile);
    }
};
