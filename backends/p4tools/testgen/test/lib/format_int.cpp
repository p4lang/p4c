...
TEST_F(FormatTest, Format01) {
    {
        const auto* typeBits = IR::IRUtils::getBitType(16);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0x10);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(64);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0x060000);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(62);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0x060000);
        ASSERT_STREQ(formatHexExpr(sixteenBits, false, false, false).c_str(), "60000");
        ASSERT_STREQ(formatHexExpr(sixteenBits, false, false, true).c_str(), "0x60000");
        ASSERT_STREQ(formatHexExpr(sixteenBits, false, true, false).c_str(), "0000000000060000");
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(1);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0x1);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(16, true);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, -1);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(16, true);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, -32767);
...
TEST_F(FormatTest, Format02) {
    {
        ...
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 012);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(8, true);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, -012);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(16);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 020);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(8);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 010);
...
TEST_F(FormatTest, Format03) {
    {
        const auto* typeBits = IR::IRUtils::getBitType(8);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0b11);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(8, true);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, -0b00111111);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(16);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, 0b10000);
    ...
    {
        const auto* typeBits = IR::IRUtils::getBitType(16, true);
        const auto* sixteenBits = IR::IRUtils::getConstant(typeBits, -0b0000000000010000);
