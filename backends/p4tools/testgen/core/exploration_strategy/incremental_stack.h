#ifndef TESTGEN_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_
#define TESTGEN_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_
...
#endif /* TESTGEN_CORE_EXPLORATION_STRATEGY_INCREMENTAL_STACK_H_ */
