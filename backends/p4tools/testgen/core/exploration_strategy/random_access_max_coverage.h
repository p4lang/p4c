#ifndef TESTGEN_CORE_EXPLORATION_STRATEGY_RANDOM_ACCESS_MAX_COVERAGE_H_
#define TESTGEN_CORE_EXPLORATION_STRATEGY_RANDOM_ACCESS_MAX_COVERAGE_H_
...
#endif /* TESTGEN_CORE_EXPLORATION_STRATEGY_RANDOM_ACCESS_MAX_COVERAGE_H_ */
