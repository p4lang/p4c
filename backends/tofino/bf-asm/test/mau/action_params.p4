...
action action_1(param0, param1, param2){
    modify_field(pkt.field_g_16, param0);
    modify_field(pkt.field_i_16, param1);
    modify_field(pkt.field_j_16, param2);
}
...
action action_2(param0, param1, param2){
    modify_field(pkt.field_h_16, param0);
    modify_field(pkt.field_i_16, param1);
    modify_field(pkt.field_j_16, param2);
}
...
action action_3(param0){
    modify_field(pkt.field_k_16, param0);
}
...
table table_1 {
    ...
    default_action : action_1(0xffff,0xdead,0xbeef);
...
table table_2 {
    ...
    default_action : action_2(0x1111, 0x2222, 0x3333);
    size : 2048;
}
 
table table_3 {
    reads {
        pkt.field_k_16: ternary;
    }
    actions {
       do_nothing;

    }
    default_action : action_3(0xf);
    size : 2048;
}
