...
action action_0(my_param_0, my_param_1, my_param_2,
   ...
   modify_field(test.field_9, my_param_9);
   ...
   modify_field(test.field_15, my_param_15);
   ...
   modify_field(test.field_24, my_param_24);
   ...
   modify_field(test.field_29, my_param_29);
   modify_field(test.field_30, my_param_30);
