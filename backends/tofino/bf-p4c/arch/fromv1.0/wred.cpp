...
IR::Ptr<IR::Type_Extern> P4V1::WREDConverter::convertExternType(P4V1::ProgramStructure *structure,
                                                                const IR::Type_Extern *, cstring) {
    if (use_v1model()) structure->include("tofino/wred.p4"_cs);
    return nullptr;
}

IR::Ptr<IR::Declaration_Instance> P4V1::WREDConverter::convertExternInstance(
...
IR::Ptr<IR::Statement> P4V1::WREDConverter::convertExternCall(P4V1::ProgramStructure *structure,
