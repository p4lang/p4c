...
#ifndef BACKENDS_COMMON_LOWER_H_
#define BACKENDS_COMMON_LOWER_H_
...
/**
Some backend (bmv2 & dpdk) do not support complex expressions for a select or
as arguments to external functions. Such expressions are lifted into a
temporaries. Also, convert a statement like lookahead<T>() into
tmp = lookahead<T>();
*/
...
#endif /* BACKENDS_COMMON_LOWER_H_ */
