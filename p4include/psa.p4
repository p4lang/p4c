 ...
 * times.  The PRE is made available to the Ingress programmable block
 * using the same mechanism as packet_in. A corresponding Buffering
 * and Queueing Engine (BQE) extern is defined for the Egress
 ...
 * Replication Engine (PRE) extern is defined for the Igress pipeline
