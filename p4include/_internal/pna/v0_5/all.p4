...
#include <_internal/pna/v0_5/extern_checksum.p4>
#include <_internal/pna/v0_5/extern_counter.p4>
#include <_internal/pna/v0_5/extern_meter.p4>
#include <_internal/pna/v0_5/extern_register.p4>
#include <_internal/pna/v0_5/extern_random.p4>
#include <_internal/pna/v0_5/extern_action.p4>
#include <_internal/pna/v0_5/extern_digest.p4>
