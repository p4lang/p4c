 ...
 * then the simple_switch_psa process exits.  It is still to be
 * determined, implemented, and documented precisely how assert will
 * behave for the P4 DPDK target.
 *
