...
if(NOT ${BLACK_CMD} OR NOT (NOT ${ISORT_CMD}))
  ...
  if(DEFINED BLACK_FILES)
    ...
    add_custom_target(
      black
      COMMAND xargs -a ${BLACK_TXT_FILE} -r -d '\;' ${BLACK_CMD} --check --diff -- || echo ${RED}black failed. Run \"make black-fix-errors\" to fix the complaints.${COLOURRESET}
      WORKING_DIRECTORY ${P4C_SOURCE_DIR}
    ...
    add_custom_target(
      isort
      COMMAND xargs -a ${BLACK_TXT_FILE} -r -d '\;' ${ISORT_CMD} --check --diff -- || echo ${RED}isort failed. Run \"make isort-fix-errors\" to fix the complaints.${COLOURRESET}
      WORKING_DIRECTORY ${P4C_SOURCE_DIR}
