...
#define MGID_TABLE_SIZE     4096
#define L1_MAX_ENTRIES      4096
#define L2_MAX_ENTRIES      8192
...
struct L2Entry {
    ...
    L2Entry(l1_hdl_t l1_hdl, std::bitset<512>port_map) :
...
class McPre {
    ...
    public:
        ...
        McReturnCode mc_l2_node_create(const l1_hdl_t, l2_hdl_t *, std::bitset<512> port_map);
        McReturnCode mc_l2_node_update(const l2_hdl_t l2_hdl, std::bitset<512> port_map);
    ...
    private:
        ...
        mutable boost::shared_mutex mgid_mutex;
        mutable boost::shared_mutex l1_mutex;
        mutable boost::shared_mutex l2_mutex;
};
#endif
