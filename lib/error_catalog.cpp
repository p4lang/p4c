...
const int ErrorType::WARN_DUPLICATED        = 1018;
const int ErrorType::WARN_OVERLAPING        = 2019;
...
std::map<int, cstring> ErrorCatalog::errorCatalog = {
    ...
    { ErrorType::WARN_DUPLICATED,        "duplicated"},
    { ErrorType::WARN_OVERLAPING,        "overlaping"},
};
