...
/// and it is pretty common code pattern that does something like this:
///   IR:: Node *n = new Declaration();
///   n->to<IDeclaration>();
///
...
// TypeIdResolver provides a unified way to specified type name `T`. Typeid
...
//   - 0x02 for IndexedVector<T> with lot 56 bits contain typeid of `T`.
