...
Compile P4_16 or P4_14 source code to BMv2 behavioral model
`simple_switch`:
...
Auto-translate P4_14 source to P4_16:
...
might be imposed by any particular compiler back end.  No output
except error/warning messages.
...
Generate PDF of parser instance named "ParserImpl" generated by
p4c-graphs above (search for graphviz below for its install
instructions):
