 ...
 * be a simple identifier that will be declared in namespace P4::IR.  Aliases can be defined
...
#define IRNODE_ALL_TEMPLATES(M, ...)                                                              \
    IRNODE_ALL_TEMPLATES_AND_DIRECT_AND_INDIRECT_BASES(REMOVE_TEMPLATE_BASES_ARG, IR_TREE_IGNORE, \
                                                       IR_TREE_IGNORE, IR_TREE_IGNORE, M,         \
                                                       ##__VA_ARGS__)
#define IRNODE_ALL_TEMPLATES_WITH_DEFAULTS(M, ...)      \
    IRNODE_ALL_TEMPLATES_AND_DIRECT_AND_INDIRECT_BASES( \
        REMOVE_TEMPLATE_BASES_ARG, IR_TREE_IGNORE, IR_TREE_IGNORE, IR_TREE_COPY, M, ##__VA_ARGS__)
