...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".do_clone_e2e") action do_clone_e2e() {
        ...
        clone3<tuple_0>(CloneType.E2E, 32w1, { meta._mymeta_clone_e2e_count9, meta._mymeta_f111 });
    }
    @name(".do_recirculate") action do_recirculate() {
        ...
        recirculate<tuple_0>({ meta._mymeta_recirculate_count8, meta._mymeta_f111 });
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".do_resubmit") action do_resubmit() {
        ...
        resubmit<tuple_0>({ meta._mymeta_resubmit_count7, meta._mymeta_f111 });
    }
    ...
    apply {
        ...
        if (hdr.ethernet.dstAddr == 48w0x1) 
            if (meta._mymeta_resubmit_count7 < 8w6) 
